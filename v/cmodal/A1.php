...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">modal Entrada</a>
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="breadcrumb  p-l-10">Modificar Modal Entrada</span>
         ...
         <ul class="collapsible">
                                    ...
                                    <li>
                                        <div class="collapsible-header">
                                            ...
                                            <span class="blue-grey-text text-darken-2">Modal entrada </span>
                                        </div>
