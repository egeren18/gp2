...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#help" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="bdatos de Usuario">
                                ...
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        <thead>
                                            <tr>
                                                <td class="">Indice</td>
                                                <td class="td-block">Base a tranferir</td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <td class=""><?php echo $cp -> bdatosId ?></td>
                                               <td><?php echo $cp -> bdatosName ?></td>
                                               
                                               <?php if ($_SESSION["userAdmin"] == 4) { ?>
                                                        <td class="center">
                                                            <a target="_blank" href='../plugins/pdf/doc/bdatos.php?id=<?php echo $cp -> bdatosId; ?>' class='tooltipped' data-position='left' data-tooltip='Ver'><i class='material-icons blue-text'>search</i></a>
                                                        </td>
                                                        <?php } else { ?>
                                                        <td>
                                                            
                                                            <a href="../c/<?php echo $module;?>.php?m=read&cid=<?php echo $cp -> bdatosId;?>" class="tooltipped" data-position="left" data-tooltip="Consultar"><i class="material-icons rotate-90 blue-text">search</i></a>
                                                              
                                                            <a href="../c/<?php echo $module;?>.php?m=update&cid=<?php echo $cp -> bdatosId;?>" class="tooltipped m-l-10" data-position="left" data-tooltip="Modificar"><i class="material-icons blue-text">edit</i></a>
                                                            
                                                            <a href="../c/<?php echo $module;?>.php?m=delete&cid=<?php echo $cp -> bdatosId;?>" class="tooltipped m-l-10" data-position="top" data-tooltip="Eliminar"><i class="material-icons red-text">delete</i></a>
