                            ...
                            <div class="row">
                                    ...
                                    <div class="col s12 m-t-20">
                                        <ul class="collection">
                                            <li class="collection-item blue-grey lighten-5">
                                                <p>Modificar informaci&oacute;n sobre el integrante del Equipo de Trabajo. <?php echo  $c; ?></p>
                                            </li>
                                        </ul>                                                            
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col s12 m-t-20">
                                        ...
                                        <?php 
                                            if ($fa >= 1 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="active tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P1"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?>
                                        <?php 
                                            if ($fa >= 2 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="active tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P2"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 3 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P3"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 4 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class=" tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P4"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 5 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P5"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 6 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P6"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 7 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P7"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 8 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class=" tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P8"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 9 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P9"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 10 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P10"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?><?php 
                                            if ($fa >= 11 ){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P11"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?>
                                        <?php 
                                            if ($fa >= 12){ ?>
                                        <li class="tab col l3 blue-grey lighten-5">
                                        <a class="tooltipped" data-position="bottom" data-tooltip="Ejecuci&oacute;n" href="#P12"><?php echo $dP1; ?> </a>
                                        </li>
                                        <?php } ?>
