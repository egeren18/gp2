...
<form id="form_validation" action="../c/project.php?m=ccreateDb&c=<?php echo $c;?>&mmodeloId=<?php echo $mmodeloId?>&serviceId=<?php echo $serviceId;?>&md=<?php echo $md;?>" method="post">
