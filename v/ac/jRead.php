                    ...
                    <div id="main">
                        <div id="screenshot">
                                ...
                                <div class='row'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if(isset($answer -> statusId)) {
                                                                ...
                                                                echo $reviewerDate = $answer -> statusId >= 3 ? $completed -> acReviewerDate : "";
                                            ...
                                            <ul class="collapsible">
                                                <li>
                                                    <div class="collapsible-header">
                                                           ...
                                                           <?php if($answer -> a1 == 1 ){ ?> 
                                                           <label class="p-l-20">
                                                            <input  id="answer" name="a1" type="radio" value="1" required="" checked  disabled=""/>
                                                            <span>Si</span>
                                                            </label>
                                                            <?php } else{ ?>
                                                            <label class="p-l-20">
                                                            <input id="answer" name="a1" type="radio" value="1" required=""  disabled=""/>
                                                            <span>Si</span>
                                                            </label>
                                                          <?php } ?>
                                                          ...
                                                          <?php if($answer -> a1 == 2 ){ ?> 
                                                           <label class="p-l-20">
                                                            <input id="answer" name="a1" type="radio" value="2" required="" checked  disabled=""/>
                                                            <span>No</span>
                                                            </label>
                                                            <?php } else{ ?>
                                                            <label class="p-l-20">
                                                            <input id="answer" name="a1" type="radio" value="2" required=""  disabled=""/>
                                                            <span>No</span>
                                                            </label>
                                                          <?php } ?>
                                                          ...
                                                          <?php if($answer -> a1 == 3 ){ ?> 
                                                           <label class="p-l-20">
                                                            <input id="answer" name="a1" type="radio" value="3" required="" checked  disabled=""/>
                                                            <span>No Aplica</span>
                                                            </label>
                                                            <?php } else{ ?>
                                                            <label class="p-l-20">
                                                            <input id="answer" name="a1" type="radio" value="3" required=""  disabled=""/>
                                                            <span>No Aplica</span>
                                                            </label>
                                                          <?php } ?>
                                 ...
                                 <div class='row'>
                                     <div class="col s12 m-l-20 m-b-10">
                              <?php 
                                                $sig = $iid + 1;
                                                $ant = $iid - 1;      
                                        /*
