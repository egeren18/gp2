                                                      ...
                                                      <?php } ?></tr></tbody></table>
                                                                    <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a1 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a1 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <?php
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                             <b><span class="black-text">Observaci&oacute;n</span></b> 
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a2 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a2 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    $cp1 = $_cp1 -> fetch_object();
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a3 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a3 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <?php
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a4 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a4 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <?php
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a5 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a5 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    $cp1 = $_cp1 -> fetch_object();
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a6 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a6 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- categoria 7 --> 
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a7 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a7 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- categoria 8 --> 
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a8 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a8 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- categoria 9 --> 
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                              <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a9 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a9 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
                                                     ...
                                                     <!-- categoria 10 --> 
                                                      ...
                                                      <div class="row">
                                                                          <div class="col s12 m12 l12 m-t-20">
                                                                                 <b><span class="black-text">Observaci&oacute;n</span></b>
                                                                             <?php if( $procesado == null){ ;?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" ><?php echo $observacion -> a10 ;?></textarea>
                                                                            <?php }
                                                                            else{ ?>
                                                                            <textarea name="a<?php echo $i;?>" class="ckeditor" readonly><?php echo $observacion -> a10 ;?></textarea>
                                                                            <?php }?>
                                                                          </div>
                                                                    </div>
                                                                </div>
