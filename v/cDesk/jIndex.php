...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Categoria Escritorios</a>
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="blue-text p-l-10">Categorias De Escritorio</span>
                            ...
                            <div class="col s12">
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            <?php while ($cDesk = $_cDesk -> fetch_object()) { ?>
                                            <tr>
                                                <td>
                                                    <?php echo $cDesk -> cDeskName; ?>
                                                </td>
                                                <td>
                                                    <a href="
                                                        <?php
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            $allow = 1;
                                                            echo $link = $allow == 1 ? "../c/{$module}.php?m=update&id={$cDesk -> cDeskId}" : "javascript: void(0)";
                                                        }
                                                        else {
                                                            echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update&id={$cDesk -> cDeskId}" : "javascript: void(0)";
                                                        }
                                                    ...
                                                    <a href="
                                                        ...
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            $allow = 1;
                                                            echo $link = $allow == 1 ? "../c/{$module}.php?m=delete&id={$cDesk -> cDeskId}" : "javascript: void(0)";
                                                        }
                                                        else {
                                                            echo $link = $allow -> jDelete == 1 ? "../c/{$module}.php?m=delete&id={$cDesk -> cDeskId}" : "javascript: void(0)";
                                                        }
