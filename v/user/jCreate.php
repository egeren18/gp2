    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/user.php?m=createDb" method="post">
                <div class="row">
                                                    ...
                                                    <div id="P4" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <p>
                                                                    <label>
                                                                        <input name="userAdmin" type="radio" value="1" checked />
                                                                        <span>Est&aacute;ndar</span>
                                                                    </label>
                                                                </p>
                                                                <p>
                                                                    <label>
                                                                        <input name="userAdmin" type="radio" value="2"/>
                                                                        <span>Administrador</span>
                                                                    </label>
                                                                </p>
                                                                <p>
                                                                    <label>
                                                                        <input name="userAdmin" type="radio" value="3"/>
                                                                        <span>Socio de Riesgo</span>
                                                                    </label>
                                                                </p>
                                                                <p>
                                                                    <label>
                                                                        <input name="userAdmin" type="radio" value="4"/>
                                                                        <span>Consultor</span>
                                                                    </label>
                                                                </p>
                                                                <p>
                                                                    <label>
                                                                        <input name="userAdmin" type="radio" value="5"/>
