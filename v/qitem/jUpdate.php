                            ...
                            <div class="card m-t-10 m-l-5 m-r-5">
                                <div class="m-b-20 m-l-20 m-r-20">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s6 m4">
                                            <span><?php echo $questName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s6 m4">
                                            <span class="blue-grey-text text-darken-2">Item:</span>
                                        </div>

                                        <div class="col s6 m4">
                                            <span><?php echo $client -> qitemName ;?></span>
                                        </div>
                                    </div>
                                   <div class="row">
                                        <div class="col s6 m4">
                                            <span class="blue-grey-text text-darken-2">Area:</span>
                                        </div>

                                        <div class="col s6 m8">
                                            <span><?php echo $client -> qitemExp ;?></span>
                                        </div>
                                    </div>
