                ...
                <div class="col s12 m12 l12">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="breadcrumb  p-l-10">Proyectos</span>
                                                    ...
                                                    <div class="col s12 m8 l6">
                                                        <div class="input-field">
                                                            <select id="clientId" name="clientId" placeholder="" type="text" class="validate" required="">
                                                                <option value="">&nbsp;</option>
                                                                <?php
                                                                while ($r_client = $client -> fetch_object()) {

                                                                    $items = mysqli_query(
                                                                        $connection, "
                                                                        SELECT count(*) AS no FROM acanswer
                                                                        WHERE acId = '" . $r_client -> acId . "'
                                                                    ");
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $data = $r_items -> no == $r_answer -> answer ? $r_client -> clientId : ''; ?>"><?php echo $data = $r_items -> no == $r_answer -> answer ? $r_client -> clientName : ''; ?></option>
                                                                <?php } ?>
                                                            </select>
