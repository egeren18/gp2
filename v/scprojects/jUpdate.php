        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    ...
                    <form id="form_validation" action="../c/scprojects.php?m=updateDb&cid=<?php echo $cid; ?>&projectId=<?php echo $projectId ;?>"  method="post"
                                            ...
                                            <!-- datos nuevos -->
                                                    <div class="row">
                                                        <div class="col s12  m-t--20">
                                                            <div class='card-panel white-text blue-grey darken-2' style='line-height : 5px;'>Actualizar</div>
                                                        </div>
