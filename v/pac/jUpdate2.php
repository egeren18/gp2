                            ...
                            <div class="row">
                                     ...
                                     <div class="col s6 m3">
                                        ...
                                        <div class="col s6 m3">
                                                ...
                                                <div class="row"> 
                                                    ...
                                                    <div class="col s12 m-t--10">
                                                        <div class='card-panel black-text blue-grey lighten-4' style='line-height : 20px;'><?php echo $c -> pacName; ?></div>
                                                    </div>
                                                    <div class="col s12 m-t--10">
                                                        <div class='card-panel white-text blue-grey darken-2' style='line-height : 5px;'>Texto Vigente Abreviado</div>
                                                    </div>
                                                    <div class="col s12 m-t--10">
                                                        <div class='card-panel black-text blue-grey lighten-4' style='line-height : 20px;'><?php echo $c -> pap; ?></div>
                                                    </div>
                                                </div> 
                               ...
                               <div class="row">   
                                <div class="col s12">
                                        ...
                                        <form id="form_validation" action="../c/pac.php?m=createDb2&pacId=<?php echo $d; ?>&serviceId=<?php echo $pid;?>" method="post">
                                               ...
                                               <div class='card-panel white-text blue-grey darken-2' style='line-height : 5px;'>Texto a Actualizar</div></div>
                                                <div class="col s12 m6 l6">
                                                    <div class="input-field">
                                                        <textarea class="ckeditor"  id="pacName" name="pacName" placeholder="" type="text" class="validate"><?php echo $c -> pacName; ?></textarea>
                                                ...
                                                <div class="col s12 m6 l6">
                                                    <div class="input-field">
                                                        <textarea class="ckeditor"  id="pap" name="pap" placeholder="" type="text" class="validate"><?php echo $c -> pap; ?></textarea>
