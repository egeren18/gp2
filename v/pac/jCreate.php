                            ...
                            <div class="card p-t-20 p-b-15 p-l-20 p-r-20">
                              ...
                              <div class="row">   
                                <div class="col s12 m12 l3 m-t--10  ">
                                        ...
                                        <div class="col s12 m6 l5 m-t--10">
                                            <div class="input-field">
                                    ...
                                    <div class=" col s2 m6 l3 ">
                                        <a id='vGender' target="_blank" href="../c/cac.php?m=create&tsacId=<?php echo $tsacId ?>" class='btn blue waves-effect tooltipped' data-position='right' 
                                            ...
                                            <!-- EL CONTNIDO DEL DESPEGABLE -->
                                                 <div class="row">
                                                     ...
                                                     <table>
                                                            ...
                                                            <?php while ($cp = $_prisk -> fetch_object()) { ;?>
                                                                                ...
                                                                                <td id="border-grey">
                                                                                    <label>
                                                                                         ...
                                                                                         <input value="<?php echo $cp -> priskId; ?>" type="hidden" name="preguntasC1[]" />
                                                                                            <input class="filled-in" <?php echo $checked = ($cp -> access == 1 ) ? '' : ''; ?> type="checkbox" name="pc[<?php echo $cp -> priskId; ?>]" />
                                             ...
                                             <li>
                                                ...
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        <div class="row">
                                                            <?php// while ($cp = $_tabla -> fetch_object()) {?>
                                                                <div class="col l3">
                                                                    <table class="white">
                                                                        <tr class="left-align">
                                                                            <td >
                                                                                <div>
                                                                                    <label>
                                                                    <input value="<?php// echo $cp -> cuestionarioId; ?>" type="hidden" name="tsacC[]" />
                                                                    <input class="filled-in" type="checkbox" name="pc[<?php //echo $cp -> cuestionarioId; ?>]"/>
                                                                    <span class="blue-grey-text text-darken-2"><?php// echo $cp -> cuestionarioName; ?></span>
                                                                </label>
                                                                                </div> </td>
...
termina el seleccionador -->    
                              ...
                              <div class="row">
                                    <div class="col s12 m-t-20 ">
                                            <label>
                                            <input type="checkbox" class="validate filled-in red" name="risk" />
                             ...
                             <div class="row">
                                 ...
                                 <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vGender' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                    </div>
                                                </div>
