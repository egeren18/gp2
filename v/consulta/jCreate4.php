...
<div class="card white m-t-10 m-l-5 m-r-5">
    <div class="row   ">
        ...
        <ul class="collection m-t-20">
          <li class="collection-item blue-grey lighten-2 white-text">consulta Recientes</li></ul>
        ...
        <table id='example' class='display nowrap' style='width:100%'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td><?php echo $consulta -> consultaId; ?>
                    ...
                    <td><a href="<?php echo $link = $allow -> jUpdate == 1 ? "../c/consulta.php?m=update&id={$consulta -> consultaId}" : "javascript: void(0)" ?>" 
                    class="tooltipped " data-position="left" data-tooltip="Consultar">
                    <i class="material-icons <?php echo $color = $allow -> jUpdate == 1 ? "blue-text" : "grey-text"; ?>">search</i></a></td>
                    
                    <td>
                    
                                    <a href="" class="tooltipped m-l-10" data-position="top" data-tooltip="Estado">
                                    <?php if($consulta -> consultaStatus ==2){?><i class="material-icons green-text">done_all</i><?php }?>
                                    <?php if($consulta -> consultaStatus ==1){?><i class="material-icons ">done</i><?php }?>
                                    </a>
                   </td>
                                                    </tr>
                                                    <?php } ?>
...
<textarea class="ckeditor" name="consultaText" >
