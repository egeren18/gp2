...
<form id="form_validation" action="../c/project.php?m=reditDb&c=<?php echo $c;?>&amId=<?php echo $amId?>&serviceId=<?php echo $serviceId;?>&md=<?php echo $md;?>" method="post">
...
<li>
    ...
    <div class="collapsible-body">
        <textarea name="a<?php echo $contadorr;?>" class="ckeditor" readonly>
            <?php
      ...
      <div class="col s12 m-b-10">
                                            <ul class="collapsible">
                                                <li>
                                                    ...
                                                    <div class="collapsible-body">
                                                        <textarea name="obs" class="ckeditor"><?php echo  $mmodelo2 -> obs; ?></textarea>
                                                    </div>
                                                </li>
                                            </ul>
    </div>
