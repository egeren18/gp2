...
$consultatext2 = $_POST['consultatext2'];
$cat = $_POST['cat'];
...
$date = $_POST['date']; 
    ...
    $insert = $master -> prepare ("
        ...
        (consultaName, consultaText, cat, dateT, consultaText2, nombre, consultaStatus )
        VALUES
        (?,?,?,?,?,?,?)
    ");
    ...
    $insert -> bind_param (
        "ssssssi",
        $titulo, $consultatext, $cat , $date, $consultatext2, $n, $status
    );
