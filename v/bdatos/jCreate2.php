        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#help" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Base a tranferir">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col s12 m5 l4 ">
                                                            <div class="input-field">
                                                                ...
                                                                <label for="clientName">Base a tranferir</label>
                                            ...
                                            <table class="white">
                                                <thead>
                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                        ...
                                                        <td id="border-white" class="left">Base a tranferir</td>
