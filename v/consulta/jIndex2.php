...
<?php if($consulta -> consultaStatus == 2 ){?>
...
<a href="../c/consulta.php?m=delete&id=<?php  echo $consulta -> consultaId ?>" class="tooltipped m-l-10" data-position="top" data-tooltip="Consultar"><i class="material-icons red-text">delete</i></a>     
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
