    ...
    <div class="collapsible-body">
     ...
     <?php echo $puntosControlDescripcion; ?></textarea>
    							...
    							<div class="row"><div class="col s12 m-t-20">
    	 <ul class="collapsible blue-grey-text text-darken-2" >
    	 	<li class="">
    	 		<div class="collapsible-header">
    	 			<i class="material-icons blue-grey-text text-lighten-2">
    	 		    ...
    	 		    <label class="blue-text" for="Debilidades">Debilidades
    	 		     <a href="#puntoControldebilidades" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Gu&iacutea">
    ...
    <div class="collapsible-body">
     <textarea class="ckeditor" name="situacionesCriticass" >
     <?php echo $debilidades;?></textarea>
     </div>
    </li></ul>
    	 			    </div></div>
...
<div class="row">
    	 			<div class="col s12 m12 l12 m-t-10 ">
    	 		    <label class="blue-text" for="Carta">Carta de Gerencia 
    	 		    <a href="#puntoControlcarta" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Gu&iacutea">
                        <i class="material-icons blue-text">help</i>
                    </a></label>	
    	 		    <div class="m-t-10"></div>
    	 			<ul class="collapsible">
    ...
    <div class="collapsible-body">
     <textarea class="ckeditor" name="situacionesCriticass" >
     <?php echo $carta;?></textarea>
     </div>
    </li></ul>
    	 			    </div></div>
<div class="row">
    	 			<div class="col s12 m12 l12 m-t-10 ">
    	 		    <label class="blue-text" for="Debilidades"> Situaciones Criticas  
    	 		    <a href="#puntoControlsituaciones" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Gu&iacutea">
                        <i class="material-icons blue-text">help</i>
                    </a></label>	
    	 		    <div class="m-t-10"></div>
    	 			<ul class="collapsible">
     ...
     <?php echo $situaciones;?></textarea>
                            ...
                            <div class="row">
                                <div class="col s12 m-t-10">
                                    <span class="blue-grey-text font-14 left p-l-10">Â© 2019 | SAGRA GP | S.C Aguilar, Godoy y Asociados</span>
                                    <span class="blue-grey-text font-14 right p-r-10 hide-on-small-only">VersiÃ³n: 1.0.0</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    include '../v/support/modalpuntosdebilidades.php';
    include '../v/support/modalpuntoscarta.php';
    include '../v/support/modalpuntossituaciones.php';?>
    <!-- #END# Ticket -->
