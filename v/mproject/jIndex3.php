...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Categorias</a>
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="blue-text p-l-10"><?php echo $servicioName; ?> > <?php echo $etapaName; ?> </span>
                            ...
                            <a href="<?php if ($_SESSION["userAdmin"] == 4) { echo "javascript: void(0)"; } else { echo $link = $allow -> jCreate == 1 ? "../c/{$module}.php?m=create3&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}" : "javascript: void(0)"; } ?>" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                ...
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <td class="hide"> <?php echo $cp -> mcategoriaId ?> </td>
                                               <td><?php echo $cp -> categoriaText ?></td>
                                                        ...
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=index4&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}&mcategoriaId={$cp -> mcategoriaId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=index4&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}&mcategoriaId={$cp -> mcategoriaId}" : "javascript: void(0)";
                                                                }
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update&mcategoriaId={$cp -> mcategoriaId}&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update&mcategoriaId={$cp -> mcategoriaId}&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}" : "javascript: void(0)";
                                                                }
