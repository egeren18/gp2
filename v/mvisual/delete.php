...
<form id="form_validation" action="../c/mvisual.php?m=deleteDb&cacId=<?php echo $cacId;?>" method="post"
enctype="multipart/form-data" onsubmit="return checkForm(this);">
    
        <div id="delete<?php echo $cacId;?>" class="modal" style="width:28em;">
             <div class="modal-header grey lighten-3" style="">
            <div class="row" >
                    <div class="col s12 m-b-5 m-t-20 m-b-20 m-l-20 ">
                     Eliminar- <?php echo $cacName;?>
                    </div>
                </div>
            </div>
