                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="<?php echo $link = $_SESSION["userAdmin"] == 2 ? "../c/client.php?m=create&mod={$_GET['mod']}" : "javascript: void(0)" ?>" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                            ...
                                            <table id='example' class='display nowrap' style='width:100%'>
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td>Tel&eacute;fono Auxiliar</td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $client -> clientPhone1; ?></td>
                                                        <td><?php echo $client -> clientPhone2; ?></td>
                                                        <td><?php echo $client -> clientEmail; ?></td>
                                                        <td>
                                                            <a href="<?php echo "../plugins/pdf/doc/client.php?id={$client -> clientId}"; ?>" target="_blank" class="tooltipped m-l-10" data-position="left" data-tooltip="Consultar">
                                                            ...
                                                            <a href="
                                                                ...
                                                                switch ($_SESSION["userAdmin"]) {
                                                                    ...
                                                                    case 2:
                                                                        echo "../c/{$module}.php?m=update&cid={$client -> clientId}&mod={$_GET['mod']}";
                                                                        break;
                                                            ...
                                                            <a href="
                                                                <?php
                                                                echo $link = $_SESSION["userAdmin"] == 2 ? "../c/{$module}.php?m=delete&cid={$client -> clientId}&mod={$_GET['mod']}" : "javascript: void(0)"; ?>" class="tooltipped m-l-10" data-position="top" data-tooltip="Eliminar"><i class="material-icons <?php echo $color = $_SESSION["userAdmin"] == 2 ? "red-text" : "grey-text"; ?>">delete</i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
