                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/user.php?m=deleteExternalDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 m6 l4">
                                                        <div class="input-field">
                                                            <input value="<?php echo $user -> userName . " " . $user -> userSurname; ?>" type="text" disabled="">
                                                            <label for="statusName">Auditor Externo</label>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <button type="submit" class="btn blue waves-effect tooltipped" data-position="right" data-tooltip="Eliminar">
