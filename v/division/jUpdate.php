                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/division.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 m6 l4">
                                                        <div class="input-field">
                                                            <input value="<?php echo $division -> divisionName; ?>" id="divisionName" name="divisionName" placeholder="" type="text" class="validate">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vDivision' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar Cambios'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
