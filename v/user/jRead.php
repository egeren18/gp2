                                ...
                                <div class="m-b-20 m-l-20 m-r-20">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Nombre Completo:</span>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Estado Civil:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> civilStatusName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Fecha de Nacimiento:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userBirthday ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">G&eacute;nero:</span>
                                        </div>
                                        <div class="col s12 m8">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Direcci&oacute;n:</span>
                                        </div>
                                        <div class="col s12 m8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userPhone1 ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userPhone2 ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userAddress ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userCity ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userState ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m-t-10 m-b-10">
                                            <div class="blue-grey lighten-2">
                                                <p class="valign-wrapper white-text p-t-5 p-b-5 p-l-10">
                                                    <i class="material-icons m-r-20">folder</i>
                                                    Datos Laborales
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Fecha de Ingreso:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> userAdmission ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Oficina:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> officeName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Division:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> divisionName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> departmentName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">Nivel Educativo:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $user -> levelName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="m-t-10"></div>
                                    <div class="row">
                                        <?php while ($permission = $_permission -> fetch_object()) { ?>
                                        <div class="col s12 m6 l4">
                                            <label>
                                                <input class="filled-in" <?php echo $checked = ($permission -> jAccess == 1  or $permission -> jRead == 1 ) ? 'checked' : ''; ?> type="checkbox" name="jAuditAccess[<?php echo $permission -> moduleId; ?>]" disabled=""/>
                                                <span class="blue-grey-text text-darken-2"><?php echo $permission -> moduleName; ?></span>
                                            </label>
                                        </div>
                                        <?php } ?>
                                    </div>
