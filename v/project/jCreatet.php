        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#help" class="tooltipped right modal-trigger m-r-10" data-position="left" data-tooltip="termycond de Usuario">
            ...
            <form id="form_validation" action="../c/project.php?m=createDb&termycondId=<?php echo $termycondId ;?>&clientId=<?php echo $clientId ?>&serviceId=<?php echo $serviceId ?>&userId=<?php echo $userId;?>&userId2=<?php echo $userId2;?>&frecuencia=<?php echo $frecuenciaN;?>" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                        ...
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                ...
                                <a class="right tooltipped" id="a-make" href="#" data-position="left" data-tooltip="Capturar Pantalla"><i class="material-icons">photo_camera</i></a>
                                    ...
                                    <a class="right tooltipped" id="a-download" href="#" style="display:none;" data-position="left" data-tooltip="Descargar Im&aacute;gen">
                                    ...
                                    <div class="card p-t-20 p-b-15 p-l-20 p-r-20">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <input  id="first_name" type="text" value="<?php echo $clientName;?>" readonly>
                                                                <label  for="grupoId">Cliente</label>
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <input  id="first_name" type="text" value="<?php echo $serviceName;?>" readonly>
                                                                <label  for="grupoId">Servicio</label>
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <input  id="first_name" type="text" value="<?php echo $userName;?>" readonly>
                                                                <label  for="grupoId">Socio Lider</label>
                                                            </div>
                                                    </div>
                                                    
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <input  id="first_name" type="text" value="<?php echo $userName2;?>" readonly>
                                                                <label  for="grupoId">Gerente</label>
                                                            </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m2">
                                                        <div class="input-field">
                                                            <input style="" type="text" name="fecha11"  value="<?php echo $frecuenciaN;?>"  readonly>
                                                            <label for="fecha11">Frecuencia:</label>
                                                        </div>
                                                    </div>
                                                    <div class="col s12 m12 l3">
                                                        <div class="input-field">
                                                            <select id="md" name="md" placeholder="" type="text" class="validate" required>
                                                                <option value=""></option>
                                                                <?php
                                                                
                                                                while ($masterdata = $_masterdata -> fetch_object()) {?>
                                                                <option value="<?php echo $masterdata-> projectId ?>"> <?php  echo $masterdata-> projectName ;?> 
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                            <label class="font-13" for="md">Master data</label>
                                       ...
                                       <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-20">
                                                <a href="../c/termycond.php?m=index" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
...
<!--  end funcion para tomar captura -->                                
    ...
    <div id="help" class="modal">
        <div class="modal-content">
            <p class="">termycond de Usuario</p>
