                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/userSubscriber.php?m=deleteDb&sid=<?php echo $_GET["sid"]; ?>&uid=<?php echo $_GET["uid"]; ?>" method="post">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        <a href="javascript: history.go(-2)" class="btn grey waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
