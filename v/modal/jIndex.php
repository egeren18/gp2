                                                ...
                                                <td>
                                                    ...
                                                    <a href="
                                                        ...
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            ...
                                                            echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=list&id={$modal -> modalId}" : "javascript: void(0)";
                                                        }
                                                        ?>" class="tooltipped m-l-10" data-position="left" data-tooltip="Editar"><i class="material-icons 
                                                        <?php
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            $allow = 1;
                                                            echo $color = $allow == 1 ? "blue-text" : "grey-text";
