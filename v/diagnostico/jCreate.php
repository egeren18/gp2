    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/diagnostico.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l4">
                                                            <div class="input-field">
                                                                <input id="diagnosticoName" name="diagnosticoName" placeholder="" type="text" class="validate" required>
                                                                <label for="diagnosticoName">Nombre del diagn&oacute;stico</label>
                                                        ...
                                                        <div class="col s12 m6 l12 ">
                                                             <div class="input-field">
                                                                 <textarea id="ckeditor" name="diagnosticoText" class="ckeditor m-t-20" required>
                                                                 </textarea>
                                                        ...
                                                        <div class="col s12 m6 l12 ">
                                                             <div class="input-field">
                                                                 <textarea id="ckeditor" name="diagnosticoText2" class="ckeditor m-t-20" required>
                                                                 </textarea>
 ...
 <!-- img 1-->
                                                            ...
                                                            <div class="col s12 m-t-10">
                                                                <label>Imagen del Diagn&oacute;stico</label>
