    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/accessSubscriber.php?m=updateDb&sid=<?php echo $_GET["sid"]; ?>&uid=<?php echo $_GET["uid"]; ?>" method="post">
                <div class="row">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <a href="#!" class="breadcrumb"><?php echo $user -> subscriberName; ?></a>
                                ...
                                <div class="card m-t-10 m-l-5 m-r-5">
                                    <div class="card p-b-15 p-l-20 p-r-20">
                                        ...
                                        <div class="row">
                                            <?php while ($module = $_module -> fetch_object()) { $_access = mysqli_query($master, "SELECT * FROM access WHERE userId = '" . $_GET["uid"] . "' AND moduleId = '" . $module -> moduleId . "'"); $access = $_access -> fetch_object(); ?>
                                            <?php if ($module -> moduleType == 4) { ?>
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <p>
                                                            <label style="padding-left: 20px">
                                                                <input <?php echo $checked = ($access -> jList == 1 ?? '') ? 'checked' : ''; ?> value="1" type="checkbox" name="jList[<?php echo $module -> moduleId; ?>]" /><span class="blue-grey-text text-darken-2">Permitir</span>
                                                            </label>
                                                        </p>
                                                        <div class="m-t-5"></div>
                                                    </div>
