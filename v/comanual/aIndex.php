                ...
                <div class="col s12 m12 l12 m-t-5">
                    ...
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="blue-text p-l-10">Manual de Codigo </span>
                                    ...
                                    <!-- tabla -->
                                     ...
                                     <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="hide">i</td>
                                            <td><?php echo $tabla -> comanualName ;?></td>
                                                        ...
                                                        <td>
                                                              <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#read{$tabla-> comanualId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "#read{$tabla-> comanualId}" : "javascript: void(0)";
                                                                }
                                                             ...
                                                             <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#edit{$tabla-> comanualId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "#edit{$tabla-> comanualId}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#delete{$tabla-> comanualId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jDelete == 1 ? "#delete{$tabla-> comanualId}" : "javascript: void(0)";
                                                                }
    ...
    <?php  include '../v/comanual/add.php';?>
    <?php include '../v/comanual/read.php';?>
    <?php include '../v/comanual/edit.php';?>
    <?php include '../v/comanual/delete.php';?>
