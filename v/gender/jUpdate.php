        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">G&eacute;neros</a>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/gender.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 m6 l4">
                                                        <div class="input-field">
                                                            <input value="<?php echo $gender -> genderName; ?>" id="genderName" name="genderName" placeholder="" type="text" class="validate">
                                                            <label for="genderName">G&eacute;nero</label>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vGender' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar Cambios'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
