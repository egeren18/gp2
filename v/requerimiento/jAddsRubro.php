                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="requerimiento.php?m=addDb&r=<?php echo $rubroId;?>&p=<?php echo $pruebaId;?>" method="post">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col s12 m12 l12 m-t--30 ">
                                                        <div class="input-field">
                                                            <input id="srubroName" value="<?php echo $srubroName; ?>" name="srubroName" placeholder="" type="text"  readonly>
                                                            <label for="srubroName">Prueba</label>
                                                            <span class="helper-text" data-success="Listo!"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                   <div class="col s12 m12 l12 m-t--30 ">
                                                        <div class="input-field">
                                                            <input id="requrimientoName" name="requerimientoName" placeholder="" type="text" class="validate" required>
                                                ...
                                                <div class="row m-t-20">
                                                     <div class="col s12">
                                                       <a href="javascript: history.go(-2)" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
