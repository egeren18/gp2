...
$qConclusion_1 = mysqli_query($master, "SELECT * FROM qconclusion WHERE itemStatus = 1");

// select

$qConclusion_2 = mysqli_query($master, "SELECT * FROM qconclusion WHERE itemStatus = 1");

// select

$qConclusion_3 = mysqli_query($master, "SELECT * FROM qconclusion WHERE itemStatus = 1");
