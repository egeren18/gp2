...
<!-- contenido de roles de proyecto -->
 ...
 <form action="../c/termycond.php?m=createDb3&termycondId=<?php echo $termycondId?>&iid=<?php echo $iid ;?>"method="post">            
                    <div class="row">
   ...
   <!-- terminar -->
 <form action="../c/termycond.php?m=createDb33&termycondId=<?php echo $termycondId?>&serviceId=<?php echo $serviceId?>&clientId=<?php echo $clientId?> "method="post">  
         <div class="row">
