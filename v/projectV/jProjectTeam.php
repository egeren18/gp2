                                    ...
                                    <div class="row">
                                        <div class="col s12 m6 l8 m-b-10">
                                            <table class="blue-grey lighten-5">
                                                ...
                                                <tr>
                                                    <td>Proyecto:</td>
                                                    <td><?php echo $project -> serviceName; ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col s12 m-t-20 m-b-10">
                                            <table class="white">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td id="border-grey"><?php echo $team -> userName . " " . $team -> userSurname ; ?></td>
                                                        <td id="border-grey"><?php echo $team -> designatedName; ?></td>
                                                        <td id="border-grey"><?php echo $team -> roleName; ?></span></td>
                                                        <td id="border-grey"><?php echo $team -> lineName; ?></span></td>
