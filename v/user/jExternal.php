                                            ...
                                            <table id="example" class="display nowrap" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=updateExternal&id={$user -> userId}" : "javascript: void(0)" ?>" class="tooltipped m-r-10" data-position="left" data-tooltip="Modificar"><i class="material-icons <?php echo $color = $allow -> jUpdate == 1 ? "blue-text" : "grey-text"; ?>">edit</i></a>
                                                            <a href="<?php echo $link = $allow -> jDelete == 1 ? "../c/{$module}.php?m=deleteExternal&id={$user -> userId}" : "javascript: void(0)" ?>" class="tooltipped m-r-10" data-position="top" data-tooltip="Eliminar"><i class="material-icons <?php echo $color = $allow -> jDelete == 1 ? "red-text" : "grey-text"; ?>">delete</i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
