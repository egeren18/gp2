<main>
        <div class="container">
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb "><?php echo $ccaName ?></a>
                ...
                <div class="col s12 m12 l12 m-t-5">
                    ...
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="blue-text p-l-10"><?php echo $ccaName ?></span>
                                    ...
                                    <!-- tabla -->
                                     ...
                                     <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="hide">i</td>
                                            <td><?php echo $tabla -> mvisualName ;?></td>
                                                        ...
                                                        <td>
                                                              ...
                                                              <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#read{$tabla-> mvisualId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "#read{$tabla-> mvisualId}" : "javascript: void(0)";
                                                                }
                                                             ...
                                                             <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#edit{$tabla-> mvisualId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "#edit{$tabla-> mvisualId}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#delete{$tabla-> mvisualId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jDelete == 1 ? "#delete{$tabla-> mvisualId}" : "javascript: void(0)";
                                                                }
    ...
    <?php include '../v/mvisual/add2.php';?>
    <?php include '../v/mvisual/read2.php';?>
    <?php include '../v/mvisual/edit2.php';?>
    <?php// include '../v/mvisual/delete2.php';?>
