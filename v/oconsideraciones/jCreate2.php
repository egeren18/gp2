        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#help" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Carta de Contrataci&oacute;n">
                    ...
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Esquema de facturacion</span>
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col s12 m5 l4 ">
                                                            <div class="input-field">
                                                                ...
                                                                <label for="oconsideracionesName">Carta de Contrataci&oacute;n</label>
                                                    ...
                                                    <div class="col s12 m1 l1 ">
                                                         <div class="input-field">
                                                            <input id="oconsideracionesName" name="oconsideracionesName" placeholder="" type="number" class="validate" >
                                            ...
                                            <table class="white">
                                                <thead>
                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                        ...
                                                        <td id="border-white" class="left">Carta de Contrataci&oacute;n</td>
    ...
    <div id="help" class="modal">
        <div class="modal-content">
            <p class="">Esquema de Facturacion</p>
