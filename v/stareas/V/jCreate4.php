...
<div class="card white m-t-10 m-l-5 m-r-5">
    <div class="row   ">
        ...
        <ul class="collection m-t-20">
          <li class="collection-item blue-grey lighten-2 white-text">Ticket Recientes</li></ul>
        ...
        <table id='example' class='display nowrap' style='width:100%'>
                                                ...
                                                <tbody>
                                                    <?php while ($ticket = $_ticket -> fetch_object()) { ?>
                                                    <tr>
                                                    <td><?php echo $ticket -> ticketId; ?>
                    ...
                    <td><a href="<?php echo $link = $allow -> jUpdate == 1 ? "../c/ticket.php?m=update&id={$ticket -> ticketId}" : "javascript: void(0)" ?>" 
                    ...
                    <td>
                                    ...
                                    <?php if($ticket -> ticketStatus ==2){?><i class="material-icons green-text">done_all</i><?php }?>
                                    <?php if($ticket -> ticketStatus ==1){?><i class="material-icons ">done</i><?php }?>
                                    </a>
                   </td>
                                                    </tr>
                                                    <?php } ?>
