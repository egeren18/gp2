        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="../c/srubro.php?m=list" class="breadcrumb hide-on-med-and-down">Requerimiento</a>
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="../c/srubro.php?m=delete&c=<?php echo $sRubroId; ?>" class="tooltipped right" data-position="left" data-tooltip="Eliminar Registro">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="srubro.php?m=updateDb&c=<?php echo $sRubroId; ?>" method="post">
                                      
                                                <div class="row">
                                                    <div class="col s12 m12 l12 ">
                                                        <div class="input-field">
                                                            <input value="<?php echo $sRubroName; ?>" id="sRubroName" name="sRubroName" placeholder="" type="text" class="validate" required>
