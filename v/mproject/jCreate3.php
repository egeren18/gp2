                    ...
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Seleccionar Categoria</span>
...
<form id="form_validation" action="../c/mproject.php?m=createDb3&serviceId=<?php echo $_GET['serviceId'] ?>&etapaId=<?php echo $_GET['etapaId'] ?>" method="post">
                                                            ...
                                                            <div class="row">
                                                                  <div class="col s12 m12">
                                                                    <div class="input-field col s12 m5">
                                                                      <textarea id="mcategoriaText" name="mcategoriaText" class="materialize-textarea"></textarea>
                                                                      <label for="mcategoriaText">Categoria</label>
                                                                    </div>
                                                                  </div>
                                                            </div>   
