...
class Stareas {
    ...
    public static function aUpdateDb($moduleId) {
        require_once '../f/stareas/aUpdateDb.php';
    }
    ...
    public static function jDeleteDb($moduleId) {
     ...
     public static function jAsignar($moduleId) {
        require_once '../f/stareas/jAsignar.php';
    }

    public static function jAsignarDb($moduleId) {
        require_once '../f/stareas/jAsignarDb.php';
    }

    public static function jMatriz($moduleId) {
        require_once '../f/stareas/jMatriz.php';
    }
