...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Modal AC Cuestionario 4</a>
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="breadcrumb  p-l-10">Modificar Modal AC Cuestionario 4</span>
                                ...
                                <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                    <form id="form_validation" action="../c/cmodal.php?m=updateDb&id=<?php echo $_GET["id"]; ?>&mod=27" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col s12 m6 l4">
                                                <div class="input-field">
                                                    <input value="Descrici&oacute;b del Cuestionario 4" id="cmodalName" name="cmodalName" placeholder="" type="text" readonly>
         ...
         <ul class="collapsible">
                                    ...
                                    <li>
                                        <div class="collapsible-header">
                                            ...
                                            <span class="blue-grey-text text-darken-2">Descrici&oacute;b del Cuestionario 4</span>
                                        </div>
