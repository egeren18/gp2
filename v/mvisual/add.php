...
<form id="form_validation" action="../c/mvisual.php?m=createDb" method="post"
...
<div class="row">   
    <div class="col s12 m12 l6 m-t--10  ">
                        <div class="input-field">
                            <input value="" id="cacName" name="cacName" placeholder="" type="text" required>
...
<div class="row">
    ...
    <div class="col s12 m12 l12 ">
        <ul class="collapsible">
            <li>
              <div class="collapsible-header grey lighten-4"><i class="material-icons green-text">assistant</i>Texto Explicativo de la Categoria</div>
