...
$consultaTextA = $_POST["consultaTextA"];
...
// update
  ...
  foreach ($_FILES["archivo2"]['tmp_name'] as $key => $tmp_name) {
      ...
      if ($_FILES["archivo2"]["name"][$key]) {
          ...
          $directorio2 = '../consultaA/' . $id . '/'; //Declaramos un  variable con la ruta donde guardaremos los archivos
