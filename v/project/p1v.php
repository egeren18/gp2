<div class="row">
     <div class="col s12 m-t-20">
         ...
         <form action="../c/project.php?m=updateAsignarDb&cod=<?php echo 2;?>&a=<?php echo  1;?>&userId=<?php echo $user -> userId;?>&porjectId=<?php echo $p;?>" method="post" enctype="multipart/form-data">          
 <li>
 <!-- preguntas -->                                                                          
                            <!-- el beta-->                                           
                                                            ...
                                                            <div class="col l12">
                                                                       <table>
                                                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                                                        ...
                                                                                        <th id="border-white" style="width:70%;">Actividad</th>
                                                                                        <th id="border-white" class="" style="width:20%;"> ASIGNAR PERMISOS </th>
                                                                                        <th id="border-white" class="" style="width:5%;"> Horas</th>
                                                                ...
                                                                ?>
                                                                            ...
                                                                            <tr class="m-t--10 m-b--10">
                                                                                ...
                                                                                <a class=" tooltipped"  data-tooltip="Completa">
                                                                                         <label class="">
                                                                                               <input name="group1<?php echo $cp -> amId;?>" type="radio" class="blue-text"  checked disabled="disabled" />
                                                                                            <span class="blue-grey-text text-darken-2"></span>
                                                                                        </label>
                                                                                    </a>  
                                                                                    <a class=" tooltipped"  data-tooltip="Revisa">
                                                                                        <label class="">
                                                                                            <input name="group1<?php echo $cp -> amId;?>" type="radio" disabled="disabled" />
                                                                                            <span class="blue-grey-text text-darken-2"></span>
                                                                                        </label>
                                                                                    </a>  
                                                                                ...
                                                                                <?php } ?>
                                                                                 ...
                                                                                 <?php  if(0 != $cp ->  userComplete and $user -> userId != $cp ->  userComplete) {?>
                                                                                <a class=" tooltipped"  data-tooltip="Completa">
