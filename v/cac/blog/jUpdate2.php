                ...
                <div class="col s12 m12 l12 m-t-5">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">   
                                    <span class="breadcrumb  p-l-10">Revisar</span>
...
<div class="card m-t-10 m-l-5 m-r-5">
 ...
 <form id="form_validation" action="../c/blog.php?m=updateDbR&id=<?php echo $_GET["id"]; ?>" method="post"
 enctype="multipart/form-data" onsubmit="return checkForm(this);">
                                      <ul class="collection">
                        <li class="collection-item blue-grey lighten-2 white-text">Revisar</li>
                    </ul>
...
<div class="row">
       <div class="col s12 m12 l3">
             <div class="input-field">
                <input value="<?php echo $titulo; ?>" id="titulo" name="t" placeholder="" type="text" class="validate" >
     ...
     <div class="col s12 m12 l3">
             <div class="input-field">
                <input value="<?php echo $k; ?>" id="" name="" placeholder="" type="text" class="validate" readonly >
 ...
 <div class="col s12 m12 l1">
    <div class="input-field">
      <input value="<?php echo $t; ?>" id="date" name="date" placeholder="" type="text" class="validate" readonly >
          <label for="date">Fecha</label>
    </div>
  </div>

   <div class="col s6 m6 l2 m-t--15">
             <div class="input-field">
...
<div class="row">
    <div class="col s12 m12">
     ...
     <div class="col s12 l6 m-t--10 m-b-5">
           <a class="red-text" href="../v/blog/deletei2.php?c=<?php echo $blogId;?>&a=<?php echo $archivo2;?>" >Eliminar Documento</a>
              <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Eliminar el Documento Adjunto"><i class="material-icons red-text">delete</i></a>
                                                                </div>                                                                                                               
                                                                </div><?php }}}
              else{?>
...
<div class="row">
    <div class="col s12 m12">
     ...
     <div class="col s12 l6 m-t--10 m-b-5">
           <a class="red-text" href="../v/blog/deletei3.php?c=<?php echo $blogId;?>&a=<?php echo $archivo2;?>" >Eliminar Documento</a>
              <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Eliminar el Documento Adjunto"><i class="material-icons red-text">delete</i></a>
                                                                </div>                                                                                                               
                                                                </div><?php }}}
              else{?>
