        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Tipos de Suscripci&oacute;n</a>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/subscription.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 l6">
                                                        <div class="input-field">
                                                            <input value="<?php echo $subscription -> subscriptionName; ?>" id="subscriptionName" name="subscriptionName" placeholder="" type="text" class="validate">
                                                            <label for="subscriptionName">Tipo de Suscripci&oacute;n</label>
                                                            <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                        </div>
                                                    </div>
                                                    <div class="col s12 m2">
                                                        <div class="input-field">
                                                            <input value="<?php echo $subscription -> subscriptionDays; ?>" id="subscriptionDays" name="subscriptionDays" placeholder="" type="number" class="validate">
                                                            <label for="subscriptionDays">D&iacute;as</label>
                                                            <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vSubscription' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar Cambios'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
