        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Master Data Actividad</a>
                ...
                <div class="row">
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Editar Categoria</span>
                    ...
                    <form id="form_validation" action="../c/mproject.php?m=updateDb&mcategoriaId=<?php echo $_GET['mcategoriaId'] ?>&serviceId=<?php echo $_GET['serviceId'] ?>&etapaId=<?php echo $_GET['etapaId'] ?>"  method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s6 m6 l6 ">
                                                 <div class="input-field">
                                                    <input id="$serviceName" name="$serviceName" value="<?php echo $serviceName; ?>" type="text" readonly>
                                                    <label class="active" for="$serviceName">Servicio</label>
                                                 </div>
                                                 </div>
                                        
                                        <div class="col s6 m6 l6 ">
                                                 <div class="input-field">
                                                    <input id="$etapaName" name="$etapaName" value="<?php echo $etapaName; ?>" type="text" readonly>
                                                    <label class="active" for="$etapaName">Etapa</label>
                                                 </div>
                                                 </div>         
                                         ...
                                         <div class="row">
                                          <div class="col s12 m12 l12 ">
                                                 <div class="input-field">
                                                      <textarea id="ckeditor" name="categoriaText" class="ckeditor m-t-20">
                                                    <?php echo $categoriaText ; ?>
                                                     </textarea>
                                                     <label  for="categoriaText">Categoria</label>
                                                 </div>
                                         </div>
