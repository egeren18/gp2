    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/oconsideraciones.php?m=createDb" method="post">
                <div class="row">
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Carta de Contrataci&oacute;n</span>
                                        <a href="../c/oconsideraciones.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col s12 m5 l4 ">
                                                            <div class="input-field">
                                                                <input id="oconsideracionesName" name="oconsideracionesName" placeholder="" type="text" class="validate" value="Manual de Empresa familiar" readonly>
                                                                <label for="oconsideracionesName">Nombre del Manual</label>
                                                    ...
                                                    <div class="col s12 m5 l8 ">
                                                         <div class="input-field">
                                                            <input  id="oconsideracionesName" name="oconsideracionesName" placeholder="" type="text" class="validate" >
                                                            <label class="active" for="designatedId">Carta de Contrataci&oacute;n</label>
                                                         </div>
                                                    </div>
                                                </div>
                                          ...
                                          <ul class="collapsible ">         
                                             <li>
                                                <div class="collapsible-header">
                                                    ...
                                                    <span class="blue-grey-text text-darken-2">Carta de Contrataci&oacute;n</span>
                                                </div>
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        ...
                                                        <table class="white">
                                                            <tr>
                                                                <td ><input value="1" type="hidden" name="moduleId[]" />
                                                                ...
                                                                <th>Maximizar plan de negocios</th>
                                                            </tr>
                                                        ...
                                                        <table class="white">
                                                            <tr>
                                                                ...
                                                                <th>Profesionalización del negocio</th>
                                                            </tr>
                                          ...
                                          <div class="col l3">
                                                        ...
                                                        <table class="white">
                                                            <tr>
                                                                ...
                                                                <th>Comunicación y conflictos</th>
                                                            </tr>
                                             ...
                                             <div class="col l3">
                                                        ...
                                                        <table class="white">
                                                            <tr>
                                                                ...
                                                                <th>Documentación de reglas familiares</th>
                                                            </tr>
                                                        ...
                                                        <table class="white">
                                                            <tr>
                                                                ...
                                                                <th>Planes de retiro personal</th>
                                                            </tr>
                                            ...
                                            <table class="white">
                                                <thead>
                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                        ...
                                                        <td id="border-white" class="left">Categoria</td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td id="border-grey">Profesionalizaci贸n del negocio</td>
                                ...
                                <div class="col s12 m12 l12">
                                          <ul class="collapsible ">         
                                                        ...
                                                        <div class="row">
                                                            <div class="col l12">
                                                             ...
                                                             <table class="white">
                                                                    <thead>
                                                                        <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                                            <td id="border-white" class="center">Categoria</td>
                                                                            <td id="border-white" width="10%"></td>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                            ...
                                            <li>
                                                <div class="collapsible-header">
                                                    <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                    <span class="blue-grey-text text-darken-2">Preguntas y Categorias</span>
                                                </div>
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        <div class="row">
