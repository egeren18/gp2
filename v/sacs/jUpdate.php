...
<div class="container">
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    ...
                    <form id="form_validation" action="../c/sacs.php?m=updateDb&cid=<?php echo $_GET["cid"]; ?>&tsacId=<?php echo $tsacId ;?>&cuestionarioId=<?php echo $cuestionarioId;?>"  method="post"
 ...
 <!-- datos vigentes -->
                                                    <div class="row">
                                                        <div class="col s12 ">
                                                            <div class='card-panel white-text blue-grey darken-2' style='line-height : 5px;'>AC</div>
                                                        </div>
                                            ...
                                            <!-- datos nuevos -->
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l2">
                                                            <div class="input-field">
                                                               <input id="modeloName" value="<?php echo $modeloName;?>" name="modeloName" placeholder="" type="text" class="validate" readonly>
                                                                <label for="modeloName">Cuestionarios</label>
                                                                <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col s12 m12 l12 m-t--20">
                                     ...
                                     // <!-- Categoria 1 -->
                                            $_cpx1 = mysqli_query($tipoc, "
                                                ...
                                                WHERE cacId = '" . $contador .  "'and access = 1 and cacStatus = 1
                                                ");
                                        if($cp = $_cpx1 -> fetch_object() != null) {
                                    
                                            $_ccc = mysqli_query($tipod, "
                                                SELECT * FROM cuestionario
                                                WHERE cacId = '" . $contador .  "'  and access = 1 and pacStatus = 1
                                            ");
                                            
                                            $_cac1 = mysqli_query($tipoc, "
                                                SELECT * FROM cuestionario
                                                            ...
                                                            <div class="col l12">
                                                                       <table>
                                                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                                                        <th>Id</th>
                                                                                        <th id="border-white" style="width:80%;">Pregunta</th>
                                                                                        <th id="border-white">Versi&oacute;n</th>
                                                                                        <th id="border-white">Riesgo</th>
                                                                                    </tr>
                                                                ...
                                                                $can = $cp -> pacName ;?>
                                                                                ...
                                                                                <td id="border-grey">
                                                                                    <label>
                                                                                         ...
                                                                                         <input  value="<?php echo $cp -> mId; ?>" type="hidden" name="preguntasC1[]" /> 
                                                                                                <input class="filled-in " <?php echo $checked = ($cp -> access == 1 ) ? '' : ''; ?> type="checkbox" name="pc[<?php echo $cp -> mId; ?>]" /></th>
                                                                                    ...
                                                                                    <td><?php if($cp -> risk == 1) { echo "<i class='material-icons red-text'>warning</i>" ;  }else { echo "No";}?></td>
                                                                                    </tr>
