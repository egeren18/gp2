        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="../c/srubro.php?m=list" class="breadcrumb hide-on-med-and-down">sub Rubro</a>
                ...
                <div class="col s12 m12 l12">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="breadcrumb blue-text p-l-10">sub Rubro</span>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="srubro.php?m=deleteDb&c=<?php echo $sRubroId; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 m6 l4">
                                                        <div class="input-field">
                                                            <ul class="collection">
                                                                <li class="collection-item red-text">Desea eliminar el registro:</li>
                                                                <li class="collection-item"><?php echo $sRubroName; ?></li>
                                                            </ul>                                                            
                                                        </div>
                                                </div></div>
                                                <div class="row">
