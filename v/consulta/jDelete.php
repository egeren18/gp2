 ...
 <form id="form_validation" action="../c/consulta.php?m=deleteDb&id=<?php echo $_GET["id"]; ?>" method="post">
   <div class="row">
      <div class="col s12 m6 l4">
          <div class="input-field">
           <input value="<?php echo $consulta -> consultaText; ?>"type="text" disabled="">

               <label for="consultaText">Titulo</label>
