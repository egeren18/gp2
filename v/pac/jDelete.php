                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                    <form id="form_validation" action="../c/pac.php?m=deleteDb&tsacId=<?php echo $tsacId; ?>&mId=<?php echo $mId; ?>&g=<?php echo $g ?>" method="post">
                                        <div class="row">
                                            <div class="col s12 m12 l12">
                                                <div class="input-field">
                                                    <input value="<?php echo $pap;; ?>"type="text" disabled="">
