...
$update -> bind_param ("isii", $term, $amount, $currencyId, $acId);
...
if ($ps == 0) {
    if ($ps > 1048576) {
        echo "<body><script> window.location='../c/ac.php?m=item&c=" . $acId . "&q=" . $q . "&n=sizeError'</script>";
    }
}
else {
