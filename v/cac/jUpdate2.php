                ...
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            ...
                            <a href="../c/cac.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                <i class="material-icons blue-grey-text">cancel</i>
                            </a>
                        </div>
                    </div>
                    <form id="form_validation" action="../c/cac.php?m=updateDb&serviceId=<?php echo $serviceId;?>&cacId=<?php echo $cacId; ?>&maId=<?php echo $maId;?>" method="post">
                                ...
                                <div class="col s12">
                                    ...
                                    <div class="col s12 m6 l6 ">
                                                 <div class="input-field">
                                                    ...
                                                    <label class="active" for="d">Modelo</label>
                                                 </div>
                                         </div>
                                        ...
                                        <div class="col s12 m6 l6 ">
                                                 <div class="input-field">
                                                    <input id="c" name="c" value="<?php echo $client -> cacName; ?>" type="text">
                                                    <label class="active" for="c">Categoria</label>
                                                 </div> 
                                         </div>
