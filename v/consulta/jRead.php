        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb ">Revisar</a>
                    <a href="#help" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Manual de Usuario">
                        <i class="material-icons blue-text">help</i>
                    </a>
                    <a href="#consultar" class="tooltipped right modal-trigger m-r-5" data-position="left" data-tooltip="Solicitar Ayuda">
     ...
     <div class="row">
         <div class="col s12 m-t-20">
           <div class=" m-b-20 m-l-10 m-r-10">
                <form id="form_validation" action="../c/consultar.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post"
                    enctype="multipart/form-data" onsubmit="return checkForm(this);">
                                    ...
                                    if (file_exists($path2)) {
                                        ...
                                        while ($archivo2 = readdir($directorio2)) {
                                            if (!is_dir($archivo2)) {?>      
                                                ...
                                                <div class="col s12 m8 m-t-10">
                                                    <span><?php echo $consultarText; ?></span>
                                                </div>
                      ...
                      <div class="col s12 m-t-20">
                                                ...
                                                <?php if($s == 2){?><span><?php echo $consultarText2; ?></span></span><?php }?>
                                                <?php if($s == 3){?><span><?php echo $consultarText2; ?></span></span><?php }?>                          
