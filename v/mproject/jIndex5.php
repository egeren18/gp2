                                                        ...
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=read&serviceId={$cp -> serviceId}&etapaId={$cp -> etapaId}&mcategoriaId={$cp -> mcategoriaId}&actividadId={$cp -> actividadId}&mmodeloId={$cp -> mmodeloId}&modeloId={$cp -> modeloId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=read&serviceId={$cp -> serviceId}&etapaId={$cp -> etapaId}&mcategoriaId={$cp -> mcategoriaId}&actividadId={$cp -> actividadId}&mmodeloId={$cp -> mmodeloId}&modeloId={$cp -> modeloId}" : "javascript: void(0)";
                                                                }
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update3&serviceId={$cp -> serviceId}&etapaId={$cp -> etapaId}&mcategoriaId={$cp -> mcategoriaId}&actividadId={$cp -> actividadId}&mmodeloId={$cp -> mmodeloId}&modeloId={$cp -> modeloId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update3&serviceId={$cp -> serviceId}&etapaId={$cp -> etapaId}&mcategoriaId={$cp -> mcategoriaId}&actividadId={$cp -> actividadId}&mmodeloId={$cp -> mmodeloId}&modeloId={$cp -> modeloId}" : "javascript: void(0)";
                                                                }
