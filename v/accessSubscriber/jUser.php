                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="../c/accessSubscriber.php?m=list" class="tooltipped right m-l-5" data-position="left" data-tooltip="Atr&aacute;s">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            $action = $userId == $user -> userId ? 'update' : 'add';
                                                            echo $action = $userId == $user -> userId ?
                                                            "<a href='../c/accessSubscriber.php?m={$action}&sid={$_GET["sid"]}&uid={$user -> userId}' class='tooltipped right' data-position='left' data-tooltip='Modificar'><i class='material-icons'>edit</i></a>" :
                                                            "<a href='../c/accessSubscriber.php?m={$action}&sid={$_GET["sid"]}&uid={$user -> userId}' class='tooltipped right' data-position='left' data-tooltip='Asignar'><i class='material-icons'>add</i></a>";
                                                            ?>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
