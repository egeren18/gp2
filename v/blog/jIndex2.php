                ...
                <div class="col s12 m12 l12 m-t-5">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="blue-text p-l-10">Blog Revisor</span>
...
<?php }?>
<a href="../c/blog.php?m=delete&id=<?php  echo $blog -> blogId ?>" class="tooltipped m-l-10" data-position="top" data-tooltip="Consultar"><i class="material-icons red-text">delete</i></a>     
