...
<div class="container">
    ...
    <form id="form_validation" action="../c/pac.php?m=createDb" method="post">
        <div class="row">
                            ...
                            <div class="card p-t-20 p-b-15 p-l-20 p-r-20">
                                <div class="row">
                                                ...
                                                <div class="col s12 m6 l3">
                                                            <div class="input-field">
                                                                <select id="serviceId" name="serviceId" placeholder="" type="text" class="validate" required>
                                                                    <option value="">&nbsp;</option>
                                                                    <?php
                                                                    while ($r_pac = mysqli_fetch_array($d)) {
                                                                        $serviceId = $r_pac["modeloId"];
                                                                        $pacName = $r_pac["modeloName"];
                                                                        ?>
                                                                        <option value="<?php echo $serviceId; ?>"><?php echo $pacName; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <label class="font-13" for="serviceId">Modelo</label>
                                                ...
                                                <div class="col s12 m6 l3">
                                                            <div class="input-field">
                                                                <select id="cacId" name="cacId" placeholder="" type="text" class="validate" required>
                                                                    <option value="">&nbsp;</option>
                                                                    <?php
                                                                    while ($r_pac = mysqli_fetch_array($d2)) {
                                                                        $serviceId = $r_pac["cacId"];
                                                                        $pacName = $r_pac["cacName"];
                                                                        ?>
                                                                        <option value="<?php echo $serviceId; ?>"><?php echo $pacName; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                            ...
                                            <div class="col s12 m6 l6 ">
                                                 <div class="input-field">
                                                    <input id="1" name="p1" placeholder="" type="text" class="validate" required>
                                                    <label class="active" for="p1">Pregunta  abreviada</label>
                                                 </div>
                                            </div>
                                            <div class="col s12 m12 l12 ">
                                                 <div class="input-field">
                                                 <textarea id="ckeditor" name="p2" class="ckeditor m-t-20" required>
                                                     </textarea>
                                                    <label class="active" for="p2">Pregunta </label>
                                                 </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col s12 m-t-20">
                                        <a href="../c/pac.php?m=index" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
