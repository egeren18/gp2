        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Etapas</a>
            ...
            <form id="form_validation" action="../c/mproject.php?m=createDb2&serviceId=<?php echo $serviceId ?>" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Etapas</span>
                                    ...
                                    <div class="card p-t-20 p-b-15 p-l-20 p-r-20">
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="col s12 m6 l6 m-t-10 ">
                                                                    ...
                                                                    <input value="<?php echo  $serviceName  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required readonly >
                                                                    <label class="" for="titulo">Servicios:</label>
                                                                ...
                                                                <div class="col s12 m6 l6  m-t-10">
                                                                         <div class="input-field">
                                                                            <select id="etapaId" name="etapaId" placeholder="" type="text" class="validate">
                                                                                <option value="">&nbsp;</option>
                                                                                <?php while ($eName = $_eName -> fetch_object()) { ?>
                                                                                <option value="<?php echo $eName -> etapaId; ?>"><?php echo $eName -> etapaName; ?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                            <label class="font-13" for="userId">Etapa del Servicio:</label>
                                                                            <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                                        </div>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-20">
                                                <a href="../c/mproject.php?m=index" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
