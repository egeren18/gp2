<!-- Modal de a単adir -->
<form id="form_validation" action="../c/tsac.php?m=createDb" method="post"
enctype="multipart/form-data" onsubmit="return checkForm(this);">
    
        <div id="add" class="modal" style="width:28em;">
...
<div class="row">   
    <div class="col s12 m12 l12 m-t--10  ">
                        <div class="input-field">
                            <input value="" id="tsacName" name="tsacName" placeholder="" type="text" class="validate" required  >
...
enctype="multipart/form-data" onsubmit="return checkForm(this);">
        ...
        <div id="add<?php echo $tsacId;?>" class="modal" style="width:28em;">
             <div class="modal-header grey lighten-3" style="">
            <div class="row" >
                    <div class="col s12 m-b-5 m-t-20 m-b-20 m-l-20 ">
                        Modificar Modulo
...
<div class="row">   
    <div class="col s12 m12 l12 m-t--10  ">
                        <div class="input-field">
                            <input value="<?php echo $tsacName;?>" id="tsacName" name="tsacName" placeholder="" type="text" class="validate"  required  >
                            <label class="font-17" for="tsacName">Modulo</label>
                                <span class="helper-text" data-error="Campo vac&iacute;o" data-success="Listo!"></span>
                        </div>
    </div>
...
?>
<form id="form_validation" action="../c/tsac.php?m=createDb2&tsacId=<?php echo $tsacId;?>" method="post"
enctype="multipart/form-data" onsubmit="return checkForm(this);">
