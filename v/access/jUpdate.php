...
<div class="container">
    ...
    <form id="form_validation" action="../c/access.php?m=updateDb&uid=<?php echo $_GET["uid"]; ?>" method="post">
        <div class="row">
                            ...
                            <div class="card p-b-15 p-l-20 p-r-20">
                                <div class="row">
                                    ...
                                    <div class="col s6 m4 l3 m-t-30">
                                        <div id="mod" class="card hoverable <?php echo $color = ($access -> jRead == 1  or $access -> jRead == 1 ) ? 'blue-grey lighten-5' : ''; ?> height-220">
                                            <div class="card card-title <?php echo $color = ($access -> jAccess == 1  or $access -> jRead == 1 ) ? 'blue-grey' : 'blue-grey lighten-3'; ?>">
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div>
                                                    <label class="m-l-20">
                                                        <input <?php echo $checked = $access -> jRead == 1 ? 'checked' : ''; ?> value="1" type="checkbox" name="jRead[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2">Consultar</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="m-l-20">
                                                ...
                                                <div class="blue-grey lighten-4 p-t-5 p-b-5">
                                                    <label style="padding-left: 20px">
                                                        <input class="main filled-in" id="clean<?php echo $module -> moduleId; ?>" <?php echo $checked = ($access -> jAccess == 1 ) ? 'checked' : ''; ?> value="1" type="checkbox" name="jAccess[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2"> Acceso</span>
                                                    </label>
                                                </div>
                                                <div class="m-t-15">
                                                <?php if ($module -> r == 1) { ?>
                                                    <label style="padding-left: 20px">
                                                        <input class="case<?php echo $module -> moduleId; ?> filled-in" <?php echo $checked = $access -> jRead == 1 ? 'checked' : ''; ?> value="1" type="checkbox" name="jRead[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2">Consultar</span>
                                                    </label>
                                                <?php } else { ?>
                                                    <label style="padding-left: 20px">
                                                ...
                                                <?php if ($module -> c == 1) { ?>
                                                    <label style="padding-left: 20px">
                                                        <input class="case<?php echo $module -> moduleId; ?> filled-in" <?php echo $checked = $access -> jCreate == 1 ? 'checked' : ''; ?> value="1" type="checkbox" name="jCreate[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2">A&ntilde;adir</span>
                                                    </label>
                                                <?php } else { ?>
                                                    <label style="padding-left: 20px">
                                                ...
                                                <?php if ($module -> u == 1) { ?>
                                                    <label style="padding-left: 20px">
                                                        <input class="case<?php echo $module -> moduleId; ?> filled-in" <?php echo $checked = $access -> jUpdate == 1 ? 'checked' : ''; ?> value="1" type="checkbox" name="jUpdate[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2"> Modificar</span>
                                                    </label>
                                                <?php } else { ?>
                                                    <label style="padding-left: 20px">
                                                ...
                                                <?php if ($module -> d == 1) { ?>
                                                    <label style="padding-left: 20px">
                                                        <input class="case<?php echo $module -> moduleId; ?> filled-in" <?php echo $checked = $access -> jDelete == 1 ? 'checked' : ''; ?> value="1" type="checkbox" name="jDelete[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2"> Eliminar</span>
                                                    </label>
                                                <?php } else { ?>
                                                    <label style="padding-left: 20px">
