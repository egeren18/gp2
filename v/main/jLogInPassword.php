...
<div class="row ">
    <div class="col s8 m4 l3 offset-m4 offset-s2  " >
    <!-- cajita login -->
          <div class="card hoverable m-t-60 b-r-7 width-270 ">
        ...
        <div class="p-t-20 m-l-20">
            ...
            <p class="white-text m-t-60  font-22 center-align ">Donde otros se detienen, nosotros<br> avanzamos SAGRAGP tu comunidad<br>
               de auditores y consultores</p>
               <p class="white-text m-t-100   center-align ">Version 1.2</p>
        <!--<p class="font-14 blue-text ">Donde otros se detienen, nosotros avanzamos <br>
            sagragp tu comunidad de auditores y consultores </p>
         CAJITA LOGIN END -->
    </div>    
    <div class="col l9 hide-on-med-and-down" style="background-image: url('https://sagragp.com/wp-content/uploads/2022/02/Diseno-sin-titulo-6.png'); height:50em;">
