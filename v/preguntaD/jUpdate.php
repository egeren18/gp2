                        ...
                        <div id="screenshot">
                            <div class="card m-t-10 m-l-5 m-r-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m1 m-t-10">
                                            <span class="blue-grey-text text-darken-2">Diagn&oacute;stico:</span>
                                        </div>

                                        <div class="col s12 m2 m-t-10">
                                            <span><?php echo $client2 -> diagnosticoName ;?></span>
                                        </div>
                                        ...
                                        <div class="col s12 m8 m-t-10">
                                            <span><?php echo $c -> preguntaName ;?></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                                ...
                                                $_ca = mysqli_query($master, "
                                                    ...
                                                    WHERE categoriasId = '" . $audit -> categoriasId . "'
                                                ");
                                                $ca = $_ca -> fetch_object();
                                                $can = $ca -> categoriasName ;?>
                                                
                                                <div class="col s12 m6 l4 m-t-5">
                                                    <label>
                                                        <input value="<?php echo $audit -> dcpId; ?>" type="hidden" name="pc[]" />
                                                        <input class="filled-in" <?php echo $checked = ($audit -> access== 1 ) ? 'checked' : ''; ?> type="checkbox" name="jAuditAccess[<?php echo $audit -> dcpId; ?>]" disabled=""/>
