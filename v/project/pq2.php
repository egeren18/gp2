                                                                ...
                                                                <!-- tabla q contiene las actividades -->
                                                                    <table class="m-t-5" style="width:100%;">
                                                                        <tbody>
                                                                         ...
                                                                         <?php        
                                                                                $_a1 = mysqli_query($connection, "SELECT * FROM oc WHERE amId = '" . $cp -> amId. "' and a = 1");
                                                                                $a1 = $_a1 -> fetch_object();
                                                                                
                                                                                
                                                                                $_a2 = mysqli_query($connection, "SELECT * FROM oc WHERE amId = '" . $cp -> amId. "' and a = 2");
                                                                                $a2 = $_a2 -> fetch_object();
                                                                                
                                                                                $_a3 = mysqli_query($connection, "SELECT * FROM oc WHERE amId = '" . $cp -> amId. "' and a = 3");
                                                                                $a3 = $_a3 -> fetch_object();
                                                                                $_a4 = mysqli_query($connection, "SELECT * FROM oc WHERE amId = '" . $cp -> amId. "' and a = 4");
                                                                                $a4 = $_a4 -> fetch_object();
                                                                               ...
                                                                               ?> 
                                                                                <td class="center " style="width:3%;background-color:white">
                                                                                    <div <?php if ($a1 -> a == 1){?> class='q-items b-b-red'<?php }else{?> class='q-items b-b-white' <?php }?>  
                                                                                 ...
                                                                                 <td class="center white"   style="width:3%; background-color:#cfd8dc">
                                                                                    <div <?php if ($a2 -> a == 2){?> class='q-items b-b-red'<?php }else{?> class='q-items b-b-white' <?php }?>  
                                                                                    style="margin-right:0.3em; background-color:white;"><a href='#' class="orange-text" >
                                                                                    CG
                                                                                         </a></div>
                                                                                         </td>
                                                                                <td class="center white " style="width:3%;background-color:#cfd8dc">         
                                                                                    <div <?php if ($a3 -> a == 3){?> class='q-items b-b-red'<?php }else{?> class='q-items b-b-white' <?php }?>  
                                                                                    style="margin-right:0.3em; background-color:white"><a href='#' class="red-text" >
                                                                                    SC
                                                                                         </a></div>
                                                                                         </td>
                                                                                <td class="center white " style="width:3%;background-color:#cfd8dc">
                                                                                    <div <?php if ($a4 -> a == 4){?> class='q-items b-b-red'<?php }else{?> class='q-items b-b-white' <?php }?>  
                                                                                ...
                                                                                <?php
                                        $rcontador = 1;
                                        $status = mysqli_query($pquest, "SELECT * FROM permisos$vv WHERE userId = '" . $_SESSION["userId"] . "' and role != 0  and etapaId = 2 and amId = '" . $cp -> amId . "'");
