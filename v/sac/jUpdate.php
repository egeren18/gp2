...
<div class="container">
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    ...
                    <form id="form_validation" action="../c/sac.php?m=updateDb&cid=<?php echo $_GET["cid"]; ?>&tsacId=<?php echo $tsacId ;?>&cuestionarioId=<?php echo $cuestionarioId;?>"  method="post"
 ...
 <!-- datos vigentes -->
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l2">
                                                            <div class="input-field">
                                                               <input id="v" value="<?php echo $ab = $veve -1 ;?>" name="v" placeholder="" type="text" class="validate" readonly>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="collapsible-body">
                                                                       ...
                                                                       <!-- tabla -->
                                                                                ...
                                                                                ?> 
                                                                                    <tr>
                                                                                        <td id="border-grey"><?php echo $tabla -> mId ;?></td>
                                                                                        <td id="border-grey"><?php echo $cacName ;?></td>
                                                                                        <td id="border-grey"><?php echo $tabla -> pap ;?></td>
                                                                                        <td id="border-grey"><?php echo $tabla -> v ?></td>
                                                                                    </tr>
                                                                                    <?php } ?>
                                                                       </table>
                                                                       <!--tabla -->
                                                                                ...
                                                                                <td id="border-grey">
                                                                                    <label>
                                                                                         ...
                                                                                         <input value="<?php echo $cp -> mId; ?>" type="hidden" name="preguntasC1[]" />
                                                                                            <input class="filled-in" <?php echo $checked = ($cp -> access == 1 ) ? '' : ''; ?> type="checkbox" name="pc[<?php echo $cp -> mId; ?>]" />
                                                                                            <span class="blue-grey-text text-darken-2"><?php echo $can; ?> </span>
                                                                                     </label>
                                                                                </td>
                                                                                
                                                                                        <td id="border-grey"><?php echo $cp -> v ?></td>
                                                                                    </tr>
