        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="breadcrumb  p-l-10">consultad</span>
...
<form id="form_validation" action="../c/consulta.php?m=createDb" method="post"
...
<textarea class="ckeditor" name="consultaText" readonly><?php echo $consultaText ; ?>
</textarea></div>
</li>
</ul></div>
</div>
...
<div class="card white m-t-10 m-l-5 m-r-5">
    <div class="row   ">
        ...
        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
<!-- aqui esta el formulario enviado por el usuario -->
<form id="form_validation" action="../c/consulta.php?m=updateDbR&id=<?php echo $_GET["id"]; ?>" method="post"
 enctype="multipart/form-data" onsubmit="return checkForm(this);">
...
<div class="collapsible-body">    
<textarea class="ckeditor" name="consultaTextA" ><?php echo $consultaTextA ; ?>
</textarea></div>
</li>
</ul></div>
</div>
   ...
   <ul class="collection m-t-20">
      <li class="collection-item blue-grey lighten-2 white-text">Imagen</li>
              ...
              <div class="row">
                 ...
                 <div class="row">
                 <div class="col s12  m-t--10 m-b-5">
                <a class="blue-text" target="_blank" href="<?php echo $path2;?>/<?php echo $archivo2;?>">Vers Imagen</a>
         <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Ver el Documento Adjunto"><i class="material-icons blue-text">info</i></a>
                                                                </div>

          <div class="col s12 l5">
           <a class="red-text" href="../v/consulta/deletei.php?c=<?php echo $_GET["id"];?>&a=<?php echo $archivo2;?>" >Eliminar Documento</a>
...
<div class="row">   
    <div class="col s12 m6 l3 m-t-10 ">
                        <div class="input-field">
                            <input value="<?php echo $nameA;?>"  id="n" name="n" placeholder="" type="text" class="validate" readonly>
                            <label class="" for="n">Completado</label>
