...
$categoriaText = $_POST['mcategoriaText'];
...
//enviar a base de datos
    $insert = $master -> prepare ("
        INSERT INTO mcategoria
        (serviceId, etapaId, categoriaText)
        VALUES
        (?,?,?)
    ");
//enviar con parametros las variables declaradas
    ...
    echo "<script> window.location='../c/{$module}.php?m=index3&n=added&serviceId={$serviceId}&etapaId={$etapaId}'</script>";
