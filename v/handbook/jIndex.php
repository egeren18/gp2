                        ...
                        <div class="col s12">
                            <span class="blue-text p-l-10">Cuestionarios de <?php echo $tsacName ?></span>
                              <a href="../c/main.php?m=menu" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                ...
                                <a href="#ladd" class="tooltipped right modal-trigger" data-position="left" data-tooltip="Agregar Modelo de Cuestionario">
                                   ...
                                   <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                             ...
                                             <td><a target="_blank" href="../c/cac.php?m=cac&tsacId=<?php echo $tsacId?>&cuestionarioId=<?php echo $cp -> cuestionarioId?>">Categorias</a></td>
                                                      ...
                                                      <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=read&tsacId={$tsacId}&cuestionarioId={$cp -> cuestionarioId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=read&tsacId={$tsacId}&cuestionarioId={$cp -> cuestionarioId}" : "javascript: void(0)";
                                                                }
...
<?php include '../v/handbook/add.php' ?>
