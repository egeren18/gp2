        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m6 l3">
                    <a href="../c/project.php?m=planning&c=<?php echo $c; ?>" class="waves-effect waves-light btn btn-block blue-grey darken-2 hoverable">
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <span class="p-l-10">Cliente: <?php echo $r_project -> clientName; ?></span><br/>
                                </div>
                            </div>
                            <div class="m-l-10">
                                <div class="row">
                                        ...
                                        <div class="p-t-10 p-b-20 font-14 blue-grey-text text-darken-2">
                                            <table class="blue-grey lighten-4">
                                                <tr class="blue-grey lighten-3">
                                                    <td>L&iacute;der del Proyecto:</td>
                                                    <td><?php echo $leader -> userName . " " . $leader -> userSurname; ?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <ul class="collapsible m-l-10 m-r-10">
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                ...
                                                Procedimientos de Aceptaci&oacute;n y Continuidad
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php while ($r_qPlanning_1 = $qPlanning_1 -> fetch_object()) { if ($r_qPlanning_1 -> itemArea == 1) { ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="blue-grey lighten-2 white-text td-block">
                                                                <?php echo $r_qPlanning_1 -> itemName; ?>
                                                            </td>
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=p&c=<?php echo $c; ?>&i=<?php echo $r_qPlanning_1 -> itemId; ?>" class="secondary-content">
                                        ...
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                Comprender el Negocio y el Proceso de Evaluaci&oacute;n de la Gerencia
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php while ($r_qPlanning_2 = $qPlanning_2 -> fetch_object()) { if ($r_qPlanning_2 -> itemArea == 2) { ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="blue-grey lighten-2 white-text td-block">
                                                                <?php echo $r_qPlanning_2 -> itemName; ?>
                                                            </td>
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=p&c=<?php echo $c; ?>&i=<?php echo $r_qPlanning_2 -> itemId; ?>" class="secondary-content">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <li>
                                            ...
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php while ($r_qPlanning_3 = $qPlanning_3 -> fetch_object()) { if ($r_qPlanning_3 -> itemArea == 3) { ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="blue-grey lighten-2 white-text td-block">
                                                                <?php echo $r_qPlanning_3 -> itemName; ?>
                                                            </td>
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=p&c=<?php echo $c; ?>&i=<?php echo $r_qPlanning_3 -> itemId; ?>" class="secondary-content">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                Valoraci&oacute;n de los Riesgos
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php while ($r_qPlanning_4 = $qPlanning_4 -> fetch_object()) { if ($r_qPlanning_4 -> itemArea == 4) { ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="blue-grey lighten-2 white-text td-block">
                                                                <?php echo $r_qPlanning_4 -> itemName; ?>
                                                            </td>
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=p&c=<?php echo $c; ?>&i=<?php echo $r_qPlanning_4 -> itemId; ?>" class="secondary-content">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                Determinaci&oacute;n de la Importancia Relativa
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php while ($r_qPlanning_5 = $qPlanning_5 -> fetch_object()) { if ($r_qPlanning_5 -> itemArea == 5) { ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="blue-grey lighten-2 white-text td-block">
                                                                <?php echo $r_qPlanning_5 -> itemName; ?>
                                                            </td>
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=p&c=<?php echo $c; ?>&i=<?php echo $r_qPlanning_5 -> itemId; ?>" class="secondary-content">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                Evaluar el Uso del Trabajo de Otros y Evidencia Principal
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php while ($r_qPlanning_6 = $qPlanning_6 -> fetch_object()) { if ($r_qPlanning_6 -> itemArea == 6) { ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="blue-grey lighten-2 white-text td-block">
                                                                <?php echo $r_qPlanning_6 -> itemName; ?>
                                                            </td>
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=p&c=<?php echo $c; ?>&i=<?php echo $r_qPlanning_6 -> itemId; ?>" class="secondary-content">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
