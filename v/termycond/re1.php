...
<!-- carta -->
    <form action="../c/termycond.php?m=updateDb1&termycondId=<?php echo $termycondId?>&iid=1" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >       
    <div class="card-content">
                        ...
                        <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Ver el Documento Adjunto"><i class="material-icons blue-text">info</i></a>
                            ...
                            <div class="col s4">
                                <div class="input-field">
                                    ...
                                    <input value="<?php echo $montouse; ?>" type="number" name="a" class="form-control" readonly >
                                </div>
                            </div>
                            ...
                            <div class="col s4">
                                <div class="input-field">
                                    ...
                                    <input value="<?php echo $horasc; ?>" style="text-align: left ;" type="number" name="b" class="form-control" readonly>
                                </div>
                            </div>
                          ...
                          <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Ver el Documento Adjunto"><i class="material-icons grey-text">info</i></a>
                            ...
                            <div class="row">
                                <div class="col s3 m-t-20">
                                    <span class="blue-grey-text text-darken-2">Los t&eacute;rminos del contrato fueron aprobados?</span>
                                </div>
                                ...
                                <?php if ($desicion2 == 2){    ?>
                                  <div class="col s3 m-t-20">
                                  <label>
        <input name="group1" type="radio" value="1" checked disabled="disabled" />
        <span>Aprobado</span>
      </label> 
      <br>
       <label>
        <input name="group1" type="radio" value="2" disabled="disabled" />
        <span>Declinado</span>
      </label>                                 
                                </div>
                             ...
                             <?php if ($desicion2 == 1){    ?>
                                  <div class="col s3 m-t-20">
                                  <label>
        <input name="group1" type="radio"  value="1" disabled="disabled" />
        <span>Aprobado</span>
      </label> 
      <br>
       <label>
        <input name="group1" type="radio" value="2" checked  disabled="disabled"/>
        <span>Declinado</span>
      </label>                                 
                                </div>
