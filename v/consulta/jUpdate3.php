...
<div class="card m-t-10 m-l-5 m-r-5">
 ...
 <form id="form_validation" action="../c/consulta.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post"
...
<div class="row">
    <div class="col s12 m12">
     ...
     <div class="col s12 l6 m-t--10 m-b-5">
           <a class="red-text" href="../v/consulta/deletei.php?c=<?php echo $consultaId;?>&a=<?php echo $archivo2;?>" >Eliminar Documento</a>
 ...
 <div class="col s12 m12 l12">
  ...
  <div class="row">
       ...
       <button id="vconsulta" type="submit" class="btn blue waves-effect tooltipped" data-position="right" data-tooltip="Guardar Cambios">
