                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col s12">
                                ...
                                <a href="../c/bdatos.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                ...
                                <div class="col s6 m3">
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col s12 m12 l6 ">
                                           ...
                                           <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="ckeditor" name="bdatosText" class="ckeditor m-t-20">
                                                    <?php echo $client -> bdatosText; ?>
                                                     </textarea>
...
<div class="row">                                       
    ...
    <div class="row">
        ...
        <div class="col s12 l2">
           <a class="red-text" href="../v/bdatos/deletei.php?c=<?php echo $_GET["cid"];?>&a=<?php echo $archivo2;?>" >Eliminar Documento</a>
