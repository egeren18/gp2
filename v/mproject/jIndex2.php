        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <!-- para abrir php se usa la siguiente sintaxis <?php ?> todo lo que este dentro de eso sera codigo php -->
                            ...
                            <!--<a href="<?php if ($_SESSION["userAdmin"] == 4) { echo "javascript: void(0)"; } else { echo $link = $allow -> jCreate == 1 ? "../c/{$module}.php?m=create2&serviceId={$_GET[cid]}" : "javascript: void(0)"; } ?>" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                ...
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                               <td class="hide"><?php echo $cp -> etapaId ?></td>
                                               <td><?php echo $cp -> etapaName ?></td>
                                                        ...
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=index3&serviceId={$_GET['cid']}&etapaId={$cp -> etapaId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=index3&serviceId={$serviceId}&etapaId={$cp -> etapaId}" : "javascript: void(0)";
                                                                }
