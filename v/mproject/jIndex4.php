                ...
                <div class="card-content">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <span class="blue-text p-l-10"><?php echo $serviceName ?> > <?php echo $etapaName ?> > </span>
                            ...
                            <a href="<?php if ($_SESSION["userAdmin"] == 4) { echo "javascript: void(0)"; } else { echo $link = $allow -> jCreate == 1 ? "../c/{$module}.php?m=create4&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}&mcategoriaId={$_GET['mcategoriaId']}" : "javascript: void(0)"; } ?>" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                             ...
                             <div class="col s12">
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            <?php while ($actividad = $_actividad -> fetch_object()) { 
                                                
                                                                $canId = $actividad -> actividadId;
                                                                
                                                                 $_cac11 = mysqli_query($master, "
                                                                        SELECT * FROM mmodelo
                                            ...
                                            ?>
                                            <tr>
                                               <td class=""> <?php echo $actividad -> actividadId ?> </td>
                                               <td><?php echo $actividad-> actividadText ?></td>
                                               <td><?php echo $mo ?></td>
                                               ...
                                               <?php if ($_SESSION["userAdmin"] == 4) { ?>
                                                        <td class="center">
                                                            <a target="_blank" href='../plugins/pdf/doc/mproject.php?id=<?php echo $cp -> mprojectId; ?>' class='tooltipped' data-position='left' data-tooltip='Ver'><i class='material-icons blue-text'>search</i></a>
                                                        </td>
                                                        <?php } else { ?>
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=index5&serviceId={$serviceId}&etapaId={$etapaId}&mcategoriaId={$mcategoriaId}&actividadId={$actividad -> actividadId} ": "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=index5&serviceId={$serviceId}&etapaId={$etapaId}&mcategoriaId={$mcategoriaId}&actividadId={$actividad -> actividadId} ": "javascript: void(0)";
                                                                }
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update2&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}&mcategoriaId={$_GET['mcategoriaId']}&actividadId={$actividad -> actividadId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update2&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}&mcategoriaId={$_GET['mcategoriaId']}&actividadId={$actividad -> actividadId}" : "javascript: void(0)";
                                                                }
