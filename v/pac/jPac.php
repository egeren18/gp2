                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                   ...
                                   <a href="../c/<?php echo $module?>.php?m=create&tsacId=<?php echo $tsacId;?>&cuestionarioId=<?php echo $cuestionarioId;?>" class="tooltipped right modal-trigger" data-position="left" data-tooltip="Agregar Pregunta">
                                            ...
                                            <td><?php echo $tabla -> pacName ;?></td>
                                                        <td>
                                                          <!-- botones  -->
                                                            ...
                                                            <a href="../c/<?php echo $module?>.php?m=update&tsacId=<?php echo $tsacId;?>&cuestionarioId=<?php echo $cuestionarioId;?>&mId=<?php echo $tabla -> mId;?>&g=1" 
                                                            class="tooltipped m-l-10 modal-trigger" data-position="left" data-tooltip="Consultar">
