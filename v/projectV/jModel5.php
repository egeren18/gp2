                                                                ...
                                                                <div class="steps">
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Información de la Cuenta y Objetivo de la Prueba</div>
                                                                        </div>
                                                                        <div class="step-content one">
                                                                            <p class="p-l-20 p-t-20">Los campos del área</p>
                                                                            <div class="p-t-30 p-l-20">
                                                                                <button type="button" class="btn blue waves-effect next-btn">
                                                                    ...
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Aserciones a los Estados Financieros</div>
                                                                        </div>
                                                                    ...
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Definir Población</div>
                                                                        </div>
                                                                    ...
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Definición de Error, espectativa</div>
                                                                        </div>
                                                                    ...
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Método de Selección</div>
                                                                        </div>
                                                                    ...
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Documentar el Resultado de la Prueba realizada</div>
                                                                        </div>
                                                                    ...
                                                                    <div class="step minimized">
                                                                        <div class="step-header">
                                                                            <div class="header">Evaluación de los Resultados</div>
                                                                        </div>
                                                                        <div class="step-content seven">
                                                                            <p class="p-l-20 p-t-20">Los campos del área</p>
                                                                            <div class="p-t-30 p-l-20">
                                                                                <button type="button" class="btn blue waves-effect close-btn">
                                                                                    <i class="material-icons left">expand_more</i>
                                                                                    Continuar
                                                                                </button>
                                                                            </div>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="collapsible-body">
                                                                        ...
                                                                        <div class="steps">
                                                                            <div class="step minimized">
                                                                                <div class="step-header">
                                                                                    <div class="header">Debilidades de Control Interno</div>
                                                                                </div>
                                                                            ...
                                                                            <div class="step minimized">
                                                                                <div class="step-header">
                                                                                    <div class="header">Carta de Gerencia</div>
                                                                                </div>
                                                                                <div class="step-content nine">
                                                                                    <textarea name="r2" class="ckeditor"></textarea>
                                                                                    <div class="p-t-20">
                                                                                        <button type="button" class="btn blue waves-effect next-btn">
                                                                                            <i class="material-icons left">expand_more</i>
                                                                            ...
                                                                            <div class="step minimized">
                                                                                <div class="step-header">
                                                                                    <div class="header">Situaciones Críticas</div>
                                                                                </div>
                                                                                <div class="step-content ten">
                                                                                    <textarea name="r2" class="ckeditor"></textarea>
                                                                                    <div class="p-t-20">
                                                                                        <button type="button" class="btn blue waves-effect next-btn">
                                                                                            <i class="material-icons left">expand_more</i>
                                                                            ...
                                                                            <div class="step minimized">
                                                                                <div class="step-header">
                                                                                    <div class="header">Asientos de Ajustes</div>
                                                                                </div>
                                                                                <div class="step-content eleven">
                                                                                    <textarea name="r2" class="ckeditor"></textarea>
                                                                                    <div class="p-t-20">
                                                                                        <button type="button" class="btn blue waves-effect close-btn">
                                                                                            <i class="material-icons left">expand_more</i>
