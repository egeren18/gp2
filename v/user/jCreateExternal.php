                ...
                <div class="col s12 m12 l12 m-t-5">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            ...
                            <form id="form_validation" action="../c/user.php?m=createExternalDb" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div id="P1" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m4">
                                                                <div class="input-field">
                                                                    <input id="userBirthday" name="userBirthday" placeholder="" type="text" class="datepicker validate">
                                                    ...
                                                    <div id="P2" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 m4">
                                                                <div class="input-field">
                                                                    <input id="userPhone1" name="userPhone1" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m4">
                                                                <div class="input-field">
                                                                    <input id="userPhone2" name="userPhone2" placeholder="" type="text" class="validate">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <div class="input-field">
                                                                    <input id="userAddress" name="userAddress" placeholder="" type="text" class="validate">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m4">
                                                                <div class="input-field">
                                                                    <input id="userCity" name="userCity" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m4">
                                                                <div class="input-field">
                                                                    <input id="userState" name="userState" placeholder="" type="text" class="validate">
                                                    ...
                                                    <div id="P3" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m4">
                                                                <div class="input-field">
                                                                    <input id="userAdmission" name="userAdmission" placeholder="" type="text" class="datepicker validate">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m-t-20">
                                                                <a href="../c/user.php?m=external" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
                                                                    <i class="material-icons">close</i>
                                                                </a>
                                                                <button id="vUser" type="submit" class="btn blue waves-effect tooltipped" data-position="right" data-tooltip="Guardar">
