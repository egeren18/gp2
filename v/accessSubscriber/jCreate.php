    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/accessSubscriber.php?m=createDb&sid=<?php echo $_GET["sid"]; ?>&uid=<?php echo $_GET["uid"]; ?>" method="post">
                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-20">
                                                <div class="blue-grey lighten-1">
                                                    <p class="white-text p-t-5 p-b-5 p-l-20">Aplicaciones</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <?php while ($app = $_app -> fetch_object()) { ?>
                                            <div class="col s6 m4 l3 m-t-15">
                                                <div class="card hoverable">
                                                    <div class="card card-title blue-grey lighten-1">
                                                        <span class="white-text m-l-10 m-r-10 truncate"><?php echo $app -> moduleName; ?></span>
                                                    </div>
                                                    <div class="card-content">
                                                        <input value="<?php echo $app -> moduleId; ?>" type="hidden" name="moduleId[]" />
                                                        <p>
                                                            <label style="padding-left: 20px">
                                                                <input value="1" type="checkbox" name="jList[<?php echo $app -> moduleId; ?>]" /><span class="blue-grey-text text-darken-2">Permitir</span>
                                                            </label>
                                                        </p>
                                                        <div class="m-t-5"></div>
                                                    </div>
