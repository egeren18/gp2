                                ...
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <?php while ($cp = $_cp -> fetch_object()) { 
                                                ...
                                                ");
                                                $cp3 = mysqli_fetch_array($_cp3);
                                                // set fields
                                                $modeloName = $cp3["modeloName"];
                                            ?>
                                            <tr>
                                                        ...
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update&cid={ $cp -> serviceId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=update&cid={$cp -> serviceId}" : "javascript: void(0)";
                                                                }
                                                                ...
                                                                ?>">search</i></a>
                                                            <a href="javascript: void(0)" class="tooltipped m-l-10" data-position="left" data-tooltip="Actualizar"><i class="material-icons grey-text">edit</i></a>
