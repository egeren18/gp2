...
<div class="container">
    ...
    <form id="form_validation" action="../c/preguntaD.php?m=create2" method="post">
        <div class="row">
                        ...
                        <div class="card m-t-10 m-l-5 m-r-5">
                            ...
                            <div class="row">
                               ...
                               <div class="col s12 m12 l8  ">
                                    <div class="input-field">
                                         <input id="PreguntaName" name="PreguntaName" placeholder="" type="text" class="validate" required>
