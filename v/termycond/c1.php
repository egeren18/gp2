...
<!-- si esta vacio -->
    <form action="../c/termycond.php?m=createDb4&termycondId=<?php echo $termycondId?>&iid=1&clientId=<?php echo $clientId; ?>&serviceId=<?php echo $serviceId; ?>" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
    <div class="row">
                            <div class="col s12 m6">
                                <ul class="collection m-t-20">
                        ...
                        <div class="row">
                            <div class="col s12 m6">
                                ...
                                <input style="text-align: center;" type="text" name="f1" class="datepicker" value="" required="">
                                </div>
                            </div>
                            <div class="col s12 m6">
                                <div class="input-field">
                                <small>Recibida:</small>
                                <input style="text-align: center;" type="text" name="f2" class="datepicker" value="" >
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s4">
                                        <div class="input-field">
                                            ...
                                            <div class="col s12 m12 l12 m-b-10 ">
                                                <ul class="collapsible">
                                                    <li>
                                                <div class="collapsible-header grey lighten-4"><i class="material-icons green-text">list</i>Observaciones durante la negociaci&oacute;n</div>
                                                    <div class="collapsible-body">
