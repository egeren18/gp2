                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="../c/prueba.php?m=add" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                            ...
                                            <table id="example" class="display nowrap" style="width:100%">
                                                <thead>
                                                    <tr><td></td>
                                                        ...
                                                        <td >Rubro</td>
                                                        <td>Requerimiento</td>
                                                        <td class="td-block">Prueba</td>
                                                        
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php while ($r_prueba = mysqli_fetch_array($prueba)) { ?>
                                                    <tr><td></td>
                                                        <td><?php echo $r_prueba["clientName"]; ?></td>
                                                        <td><?php echo $r_prueba["rubroName"]; ?></td>
                                                        <td><?php echo $r_prueba["sRubroName"]; ?></td>
                                                        <td>
                                                            <a href="../c/prueba.php?m=update&c=<?php echo $r_prueba["pruebaId"]; ?>">
                                                                <?php echo $r_prueba["pruebaName"]; ?>
                                                            </a>
                                                        </td>
