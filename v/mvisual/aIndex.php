<main>
        <div class="container">
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Manual de Vistas</a>
                ...
                <div class="col s12 m12 l12 m-t-5">
                    ...
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="blue-text p-l-10">Manual de Vistas</span>
                                                        ...
                                                        <td>
                                                             <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=index2&cacId={$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jAccess == 1 ? "../c/{$module}.php?m=index2&cacId={$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                                ?>" class="tooltipped m-l-10" data-position="left" data-tooltip="Entrar en la Categoria">
                                                                 <i class="material-icons
                                                                <?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $color = $allow == 1 ? "green-text" : "grey-text";
                                                                }
                                                                else {
                                                                    echo $color = $allow -> jAccess == 1 ? "green-text" : "grey-text";
                                                                }
                                                                ?>">forward</i></a>
                                                              ...
                                                              <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#read{$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "#read{$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                             ...
                                                             <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#edit{$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "#edit{$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="<?php
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "#delete{$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jDelete == 1 ? "#delete{$tabla-> cacId}" : "javascript: void(0)";
                                                                }
                                                          ...
                                                          <!-- botones
                                                            ...
                                                            <a href="#read" class="tooltipped m-l-10 modal-trigger" data-position="left" data-tooltip="Consultar">
                                                                <i class="material-icons rotate-90   blue-text">search</i></a>
                                                                
                                                                <a href="#edit" class="tooltipped m-l-10 modal-trigger" data-position="left" data-tooltip="Modificar">
    ...
    <?php include '../v/mvisual/add.php';?>
    <?php include '../v/mvisual/read.php';?>
    <?php include '../v/mvisual/edit.php';?>
    <?php include '../v/mvisual/delete.php';?>
