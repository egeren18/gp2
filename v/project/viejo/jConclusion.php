        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Conclusi&oacute;n</a>
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l3">
                    <a href="../c/project.php?m=conclusion&c=<?php echo $c; ?>" class="waves-effect waves-light btn btn-block blue-grey darken-2 hoverable">
                        <i class="material-icons blue-text left">extension</i>
                        <span class="left">CONCLUSI&Oacute;N</span>
                    </a>
                </div>
            </div>
            <div class="row">
...
-->
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        $status = mysqli_query(
                                            $connection, "
                                            SELECT * FROM projectconclusionanswer
                                            WHERE projectId = '" . $c . "'
                                        ");

                                        while ($r_status = $status -> fetch_object()) {

                                            $icon = "<div class='q-items'><a href='../c/project.php?m=question&c=" . $c . "&p=c&i=" . $r_status -> projectIId . "'>";
                                    ...
                                    <ul class="collapsible m-l-10 m-r-10">
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                ...
                                                Evaluaci&oacute;n de la Evidencia Obtenida
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php
                                                while ($r_qConclusion_1 = mysqli_fetch_array($qConclusion_1)) {
                                                    if ($r_qConclusion_1["itemArea"] == 1) {
                                                        $itemName = $r_qConclusion_1["itemName"];
                                                        $itemId = $r_qConclusion_1["itemId"];
                                                    ?>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=c&c=<?php echo $c; ?>&i=<?php echo $r_qConclusion_1["itemId"]; ?>">
                                        ...
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                Preparar Reporte del Auditor
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php
                                                while ($r_qConclusion_2 = mysqli_fetch_array($qConclusion_2)) {
                                                    if ($r_qConclusion_2["itemArea"] == 2) {
                                                        $itemName = $r_qConclusion_2["itemName"];
                                                        $itemId = $r_qConclusion_2["itemId"];
                                                    ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=c&c=<?php echo $c; ?>&i=<?php echo $r_qConclusion_2["itemId"]; ?>">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                        ...
                                        <li>
                                            <div class="collapsible-header blue-grey-text text-darken-2">
                                                <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                Preparar Res&uacute;men de Deficiencias de Control
                                            </div>
                                            <div class="collapsible-body">
                                                <div class="m-t-10"></div>
                                                <?php
                                                while ($r_qConclusion_3 = mysqli_fetch_array($qConclusion_3)) {
                                                    if ($r_qConclusion_3["itemArea"] == 3) {
                                                        $itemName = $r_qConclusion_3["itemName"];
                                                        $itemId = $r_qConclusion_3["itemId"];
                                                    ?>
                                                <table class="m-t-5" style="width:100%;">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="center blue-grey lighten-3">
                                                                <a href="../c/project.php?m=question&p=c&c=<?php echo $c; ?>&i=<?php echo $r_qConclusion_3["itemId"]; ?>">
                                                                    <i class="material-icons blue-grey-text text-lighten-5">edit</i>
                                                                </a>
                                                            </td>
                                                        </tr>
