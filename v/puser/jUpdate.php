                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberName; ?>" id="subscriberName" name="subscriberName" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberRif; ?>" id="subscriberRif" name="subscriberRif" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberPhone1; ?>" id="subscriberPhone1" name="subscriberPhone1" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberPhone2; ?>" id="subscriberPhone2" name="subscriberPhone2" placeholder="" type="text" class="validate">
                                                    ...
                                                    <div id="P2" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberContactName; ?>" id="subscriberContactName" name="subscriberContactName" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberContactSurname; ?>" id="subscriberContactSurname" name="subscriberContactSurname" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberContactEmail; ?>" id="subscriberContactEmail" name="subscriberContactEmail" placeholder="" type="email" class="validate">
                                                    ...
                                                    <div id="P3" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberAddress; ?>" id="subscriberAddress" name="subscriberAddress" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberCity; ?>" id="subscriberCity" name="subscriberCity" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberState; ?>" id="subscriberState" name="subscriberState" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberZipCode; ?>" id="subscriberZipCode" name="subscriberZipCode" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <select id="countryId" name="countryId" placeholder="" type="text" class="validate">
                                                                        ...
                                                                        <option <?php echo $selected = $subscriber -> countryId == $country -> countryId ? "selected" : ""; ?> value="<?php echo $country -> countryId; ?>"><?php echo $country -> countryName; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberWebPage; ?>" id="subscriberWebPage" name="subscriberWebPage" placeholder="" type="text" class="validate">
                                                    ...
                                                    <div id="P4" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m6 l2">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberUsers; ?>" id="subscriberUsers" name="subscriberUsers" placeholder="" type="number" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $subscriber -> subscriberStart; ?>" id="subscriberStart" name="subscriberStart" placeholder="" type="text" class="datepicker validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <select id="subscriptionId" name="subscriptionId" placeholder="" type="text" class="validate">
                                                                        ...
                                                                        <option <?php echo $selected = $subscriber -> subscriptionId == $subscription -> subscriptionId ? "selected" : ""; ?> value="<?php echo $subscription -> subscriptionId; ?>"><?php echo $subscription -> subscriptionName; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <label>
                                                                    ...
                                                                    <input class="filled-in" <?php echo $checked = ($audit -> jAccess == 1 ?? '') ? 'checked' : ''; ?> type="checkbox" name="jAuditAccess[<?php echo $audit -> moduleId; ?>]" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <label>
                                                                    ...
                                                                    <input class="filled-in" <?php echo $checked = ($administration -> jAccess == 1 ?? '') ? 'checked' : ''; ?> type="checkbox" name="jAdministrationAccess[<?php echo $administration -> moduleId; ?>]" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <label>
                                                                    ...
                                                                    <input class="filled-in" <?php echo $checked = ($rrhh -> jAccess == 1 ?? '') ? 'checked' : ''; ?> type="checkbox" name="jRrhhAccess[<?php echo $rrhh -> moduleId; ?>]" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <label>
                                                                    ...
                                                                    <input class="filled-in" <?php echo $checked = ($support -> jAccess == 1 ?? '') ? 'checked' : ''; ?> type="checkbox" name="jSupportAccess[<?php echo $support -> moduleId; ?>]" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <label>
                                                                    ...
                                                                    <input class="filled-in" <?php echo $checked = ($net -> jAccess == 1 ?? '') ? 'checked' : ''; ?> type="checkbox" name="jNetAccess[<?php echo $net -> moduleId; ?>]" />
                                                    ...
                                                    <div id="P6" class="col s12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $riskPartner -> userName; ?>" id="riskPartnerName" name="riskPartnerName" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $riskPartner -> userSurname; ?>" id="riskPartnerSurname" name="riskPartnerSurname" placeholder="" type="text" class="validate">
                                                            ...
                                                            <div class="col s12 m6 l4">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $riskPartner -> userEmail; ?>" id="riskPartnerEmail" name="riskPartnerEmail" placeholder="" type="email" class="validate">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m-t-20">
                                                                ...
                                                                <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vSubscriber' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar Cambios'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
