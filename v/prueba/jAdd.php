                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="prueba.php?m=addRubro" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col s12 m12 l4">
								                        ...
								                        <select data-size="4" name="clientId" class="form-control show-tick" data-live-search="true" required>
								                            ...
								                            <?php while ($r_r = mysqli_fetch_array($client)) { ?>
								                                <option value="<?php echo $r_r["clientId"]; ?>"><?php echo $r_r["clientName"]; ?></option>
								                            <?php } ?>
								                        </select>
								                        <label class="font-13"  for="rubroId">Cliente</label>
