    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col s12 m-b-5">
                ...
                <a href="#!" class="breadcrumb hide-on-med-and-down">M&oacute;dulo  Cuestionario</a>
                            ...
                            <div class="row">
                                     ...
                                     <div class="col s6 m3">
                                        ...
                                        <div class="col s6 m3">
                                                ...
                                                <div class="row"> 
                                                    ...
                                                    <div class="col s12 m-t--10">
                                                        <div class='card-panel black-text blue-grey lighten-4' style='line-height : 20px;'><?php echo $pap2; ?></div>
                                                    </div>
                                                    <div class="col s12 m-t--10">
                                                        <div class='card-panel white-text blue-grey darken-2' style='line-height : 5px;'>Texto Vigente Abreviado</div>
                                                    </div>
                                                    <div class="col s12 m-t--10">
                                                        <div class='card-panel black-text blue-grey lighten-4' style='line-height : 20px;'><?php echo $pacName2; ?></div>
                                                    </div>
                                                </div> 
                               ...
                               <div class="row">   
                                <div class="col s12">
                                        ...
                                        <form id="form_validation" action="../c/pac.php?m=createDb2&id=<?php echo $mId; ?>&serviceId=<?php echo $serviceId;?>" method="post">
                                               ...
                                               <div class='card-panel white-text blue-grey darken-2' style='line-height : 5px;'>Texto a Actualizar</div></div>
                                                ...
                                                <div class="col s12 m6 l6">
                                                    <div class="input-field">
                                                        <textarea class="ckeditor"  id="pap" name="pap" placeholder="" type="text" class="validate"><?php echo $pap;?></textarea>
                                                        <label  for="pap">Texto Pregunta </label>
                                                        <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                    </div>
                                                </div>
                                                <div class="col s12 m6 l6">
                                                    <div class="input-field">
                                                        <textarea class="ckeditor"  id="pacName" name="pacName" placeholder="" type="text" class="validate"><?php echo $pacName;?></textarea>
                                                         <label  for="pacName">Texto Pregunta Abreviado</label>
                                                        <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                    </div>
                                                </div>
