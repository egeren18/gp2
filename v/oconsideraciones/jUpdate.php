                            ...
                            <div class="card m-t-10 m-l-5 m-r-5">
                                <div class="m-b-20 m-l-20 m-r-20">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s6 m4">
                                            <span><?php echo $oconsideracionesName ; ?></span>
                                        </div>
                                        </div>
                                        <div class="m-t-20"></div>
                                        <div class="row">
                                        <div class="col s6 m2">
                                            <span class="blue-grey-text text-darken-2">Texto Carta de Contrataci&oacute;n:</span>
                                        </div>

                                        <div class="col s6 m12 m-t-10">
                                            <span><?php echo $client -> oconsideracionesText; ?></span>
                                        </div>
                                    ...
                                    <div class="m-t-20"></div>
                                        <div class="row">
                                        <div class="col s6 m2">
                                            <span class="blue-grey-text text-darken-2">Texto Carta de Contrataci&oacute;n2:</span>
                                        </div>

                                        <div class="col s6 m12 m-t-10">
                                            <span><?php echo $client -> oconsideracionesText2; ?></span>
                                        </div>
