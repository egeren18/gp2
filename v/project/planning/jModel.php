                                            ...
                                            <div class="card-content">
                                                <div class="m-l-10 m-t-10 m-r-10">
                                                    ...
                                                    <div class="col s12">
                                                        <label>
                                                            <input type="checkbox" class="validate " required="" />
                                                            <span class="orange-text">CG</span>
                                                        </label>
                                                    </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="col s12">
                                                        <label>
                                                            <input type="checkbox" class="validate " required="" />
                                                            <span class="black-text">Revisado</span>
                                                        </label>
                                                    </div>
                                                    </div>
                                                    <div class="row">
                                                    <div class="col s12">
                                                        <label>
                                                            <input type="checkbox" class="validate " required="" />
                                                            <span class="black-text">Terminado</span>
                                                        </label>
                                                    </div>
                                                    </div>
                                                    <div class="row">
