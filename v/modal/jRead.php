        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="breadcrumb blue-grey-text text-darken-2 p-l-10">M&oacute;dulo Modal</span>
                                ...
                                <div class="m-b-20 m-l-20 m-r-20">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">M&oacute;dulo Modal</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $modal -> modalName; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">M&oacute;dulo Controlador</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $modal -> moduleController; ?></span>
                                        </div>
                                    </div>
                                    <div class="row p-b-30">
                                        <div class="col s12 m4">
                                            <span class="blue-grey-text text-darken-2">M&oacute;dulo Modal texto:</span>
                                        </div>
                                        <div class="col s12 m8">
                                            <span><?php echo $modal -> modalText; ?></span>
                                        </div>
                                    </div>
