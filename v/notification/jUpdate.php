                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/notification.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12">
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <div class="input-field">
                                                                    <input value="<?php echo $notification -> notification; ?>" type="text" disabled="">
                                                                    <label for="userName">Notificaci&oacute;n</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col s12">
                                                        <label>
                                                            <input name="notificationStatus" value="1" type="checkbox" class="validate" required="" />
