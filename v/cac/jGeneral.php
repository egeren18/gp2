                                            ...
                                            <td><?php echo $tabla -> cacName ;?></td>
                                                        <td>
                                                          <!-- botones  -->
                                                            ...
                                                            <a href="../c/<?php echo $module;?>.php?m=update&tsacId=<?php echo $tsacId;?>&cacId=<?php echo $tabla -> cacId; ?>&g=1" class="tooltipped m-l-10 modal-trigger" data-position="left" data-tooltip="Consultar">
                                                                <i class="material-icons rotate-90   blue-text">search</i></a>
                                                                
                                                                <a href="../c/<?php echo $module;?>.php?m=update&tsacId=<?php echo $tsacId;?>&cacId=<?php echo $tabla -> cacId; ?>&g=1" class="tooltipped m-l-10 modal-trigger" data-position="left" data-tooltip="Modificar">
