    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/access.php?m=createDb&uid=<?php echo $_GET["uid"]; ?>&sid=<?php echo $_GET["sid"]; ?>" method="post">
                <div class="row">
                                                ...
                                                <div class="card hoverable">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="blue-grey lighten-4 p-t-5 p-b-5">
                                                            <label class="m-l-20">
                                                                <input class="main" id="clean<?php echo $module -> moduleId; ?>" value="1" type="checkbox" name="jAccess[<?php echo $module -> moduleId; ?>]"/><span class="blue-grey-text text-darken-2"> Acceso</span>
                                                            </label>
                                                        </div>
                                                            <div class="m-t-15">
                                                            <?php if ($module -> r == 1) { ?>
