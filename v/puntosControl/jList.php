                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="../c/puntosControl.php?m=add" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                            ...
                                            <table id="example" class="display nowrap" style="width:100%">
                                                <thead>
                                                    <tr><td></td>
                                                        ...
                                                        <td class="td-block">Puntos de Control</td>
                                                        
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php while ($r_p = mysqli_fetch_array($puntosControl)) { ?>
                                                    <tr><td></td>
                                                        <td><?php echo $r_p["rubroName"]; ?></td>
                                                        <?php $name = $r_p["puntosControlName"];?>
                                                        <td>
                                                            <a href="../c/puntosControl.php?m=update&c=<?php echo $r_p["puntosControlId"]; ?>">
                                                               <p> <?php echo $name; ?></p>
                                                            </a>
                                                        </td>
                                                    </tr>
