...
<?php if($ticket -> ticketStatus == 2 ){?>
<a href="../c/ticket.php?m=update&id=<?php  echo $ticket -> ticketId ?>" class="tooltipped m-l-10" data-position="left" data-tooltip="Modificar">
...
<a href="../c/ticket.php?m=delete&id=<?php  echo $ticket -> ticketId ?>" class="tooltipped m-l-10" data-position="top" data-tooltip="Consultar"><i class="material-icons red-text">delete</i></a>     
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        ...
                                        <tbody>
                                            <?php while ($ticket = $_ticketA -> fetch_object()) { ?>
                                            <tr>
                                                <td ><?php echo $ticket -> ticketId; ?></td>
                                                <td>
                                                    <?php echo $ticket -> ticketName; ?>
