                ...
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            ...
                            <a href="../c/diagnostico.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                <i class="material-icons blue-grey-text">cancel</i>
                            </a>
                        </div>
                    </div>
                    <form id="form_validation" action="../c/diagnostico.php?m=updateDb&cid=<?php echo $_GET["cid"]; ?>"  method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m12 l12 ">
                                                 <div class="input-field">
                                                    <input id="d" name="d" value="<?php echo $diagnosticoName; ?>" type="text">
                                                    <label class="active" for="d">Diagn&oacute;stico</label>
                                                 </div>
                                         </div>
                                          <div class="col s12 m6 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="ckeditor" name="diagnosticoText" class="ckeditor m-t-20">
                                                    <?php echo $client -> diagnosticoText; ?>
                                                     </textarea>
                                         ...
                                         <div class="col s12 m6 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="ckeditor" name="diagnosticoText2" class="ckeditor m-t-20">
                                                    <?php echo $client -> diagnosticoText2; ?>
                                                     </textarea>
   ...
   <ul class="collection m-t-20">
      <li class="collection-item blue-grey lighten-2 white-text">Imagen</li>
         ...
         <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Ver el Documento Adjunto"><i class="material-icons blue-text">info</i></a>
                                                                 ...
                                                                 <div class="col s12 l2">
           <a class="red-text" href="../v/diagnostico/deletei.php?c=<?php echo $_GET["cid"];?>&a=<?php echo $archivo2;?>" >Eliminar Documento</a>
                      ...
                      <a class="grey-text" href="#!">Ver Documento</a>
                          <a href="#!" class="tooltipped left m-r-10" data-position="right" data-tooltip="Ver el Documento Adjunto"><i class="material-icons grey-text">info</i></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-10 ">
                                                <a href="../c/diagnostico.php?m=index" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
