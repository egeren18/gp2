        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="blue-text p-l-10">Modelo</span>
                            <a href="javascript: history.go(-1);" class="tooltipped right " data-position="left" data-tooltip="Cerrar"><i class="material-icons blue-text">cancel</i></a>
                            <a href="<?php if ($_SESSION["userAdmin"] == 4) { echo "javascript: void(0)"; } else { echo $link = $allow -> jCreate == 1 ? "../c/{$module}.php?m=create5&serviceId={$_GET['serviceId']}&etapaId={$_GET['etapaId']}&mcategoriaId={$_GET['mcategoriaId']}&actividadId={$_GET['actividadId']}" : "javascript: void(0)"; } ?>" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m6 l4 m-t-10 ">
                                                <div class="input-field">
                                                        <input value="<?php echo  $modeloName  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required readonly >
                                                        <label class="" for="titulo">Modelo:</label>
                                        ...
                                        <div class="col s12 m6 l4 m-t-10 ">
                                                <div class="input-field">
                                                        <input value="<?php echo  $npregunta  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required readonly >
                                                        <label class="" for="titulo">Numero de preguntas:</label>
                                        ...
                                        <div class="col s12 m6 l4 m-t-10 ">
                                                <div class="input-field">
                                                        <input value="<?php echo  $normaText  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required readonly >
                                                        <label class="" for="titulo">Norma:</label>
                                        ...
                                        <div class="row">
                                            <div class="col s12 m12 l12 ">
                                                <div class="input-field">
                                                    <textarea id="ayudaText" name="ayudaText" class="ckeditor m-t-20"readonly>
                                                    <?php echo $ayudaText ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 1) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto1" name="texto1" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText1 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 2) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto2" name="texto2" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText2 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 3) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto3" name="texto3" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText3 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 4) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto4" name="texto4" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText4 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 5) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto5" name="texto5" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText5 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 6) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto6" name="texto6" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText6 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 7) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto7" name="texto7" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText7 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 8) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto8" name="texto8" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText8 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 9) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto9" name="texto9" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText9 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 10) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto10" name="texto10" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText10 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 11) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto11" name="texto11" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText11 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 12) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto12" name="texto12" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText12 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 13) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto13" name="texto13" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText13 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 14) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto14" name="texto14" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText14 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 15) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto15" name="texto15" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText15 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 16) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto16" name="texto16" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText16 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 10) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto17" name="texto17" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText17 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 18) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto18" name="texto18" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText18 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 19) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto19" name="texto19" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText19 ?>
                                                     </textarea>
                                        ...
                                        <?php if ($npregunta >= 20) { ?>
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="texto20" name="texto20" class="ckeditor m-t-20"readonly>
                                                    <?php echo $mText20 ?>
                                                     </textarea>
