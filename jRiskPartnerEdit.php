                        ...
                        <div class="card-content">
                            ...
                            <div class='row'>
                                <div class="m-l-10 m-r-10">
                                    ...
                                    <form name="" class="form" id="form_validation" action="ac.php?m=reviewerUpdate&aid=<?php echo $aid; ?>&qid=<?php echo $qid; ?>&iid=<?php echo $iid; ?>" method="post">
                                        <div class="col s12 m-t-20">
                                            <label>
                                        ...
                                        <div class="col s12">
                                            <label>
                                                ...
                                                <span class="blue-grey-text text-darken-2"><span class="blue-text">Revisado!</span>
                                            </label>
                                        </div>
