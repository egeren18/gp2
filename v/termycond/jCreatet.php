    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/termycond.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Terminos y Condiciones</span>
...
<!--  end funcion para tomar captura -->
                                ...
                                <div class="card m-t-10 m-l-5 m-r-5">
                                    <div class="card p-t-20 p-b-15 p-l-20 p-r-20">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <select id="clientId" name="clientId" placeholder="" type="text" class="validate">
                                                                    <option value="<?php echo $clientId;?>"><?php echo $cn;?></option>
                                                              
                                                                </select>
                                                                <label class="font-13" for="grupoId">Cliente</label>
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <select id="serviceId" name="serviceId" placeholder="" type="text" class="validate">
                                                                    <option value="">&nbsp;</option>
                                                                    <?php while ($g = $_service -> fetch_object()) { ?>
                                                                    <option value="<?php echo $g -> serviceId; ?>"><?php echo $g -> serviceName; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                    ...
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                ...
                                                                <label class="font-13" for="userId">Lider:</label>
                                                                <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <select id="userId2" name="userId2" placeholder="" type="text" class="validate">
                                                                    <option value="">&nbsp;</option>
                                                                    <?php while ($g = $_user2 -> fetch_object()) { ?>
                                                                    <option value="<?php echo $g -> userId; ?>"><?php echo $g -> userName;?> <?php echo $g->userSurname; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <label class="font-13" for="userId2">Gerente:</label>
                                                                <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                            </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m2 m-t--10">
                                                        <div class="input-field">
                                                            <label class="font-13" for="fecha11">Frecuencia de Revisi&oacute;n:</label>
                                                            <input style="" type="text" name="fecha11" class="datepicker" value="" required="">
                                                        </div>
                                                    </div>
                                                </div>
