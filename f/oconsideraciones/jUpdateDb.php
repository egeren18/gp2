...
// var
$oconsideracionesName = filter_var($_POST['d'], FILTER_SANITIZE_STRING);
$oconsideracionestext = filter_var($_POST['oconsideracionesText'], FILTER_SANITIZE_STRING);
$oconsideracionestext2 = filter_var($_POST['oconsideracionesText2'], FILTER_SANITIZE_STRING);
// update

$update = $master -> prepare ("
    UPDATE oconsideraciones
    SET
    oconsideracionesName = ?,
...
$update -> bind_param (
    "sssi",
    $oconsideracionesName, $oconsideracionestext, $oconsideracionestext2, $_GET["cid"]
);
...
$id = $_GET["cid"];
    ...
    foreach ($_FILES["archivo2"]['tmp_name'] as $key => $tmp_name) {
        ...
        if ($_FILES["archivo2"]["name"][$key]) {
            ...
            $directorio2 = '../oconsideraciones/' . $id . '/'; //Declaramos un  variable con la ruta donde guardaremos los archivos
