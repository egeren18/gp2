                                    ...
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        <thead>
                                            <tr>
                                                ...
                                                <td class="td-block">Solicitud de Cotizaci&oacute;n</td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if ($cp -> a12 ==1){?><i class="material-icons blue-text">done</i> <?php }else  {?> <?php }?></td>
                                                <td>
                                                    ...
                                                    <a href="
                                                        ...
                                                        ?>
                                                       " class="tooltipped m-l-10" data-position="left" data-tooltip="Consultar">
                                ...
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20 hide-on-med-and-down">
                                   <table id='examplezz' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $diagnostico;?></td>
                                                <td style="width:10%;"><?php echo $cp -> clientName; ?></td>
                                                <td style="width:6%;"><?php echo $cp -> clientContact; ?></td>
                                                <td style="width:10%;"><?php echo $cp -> correoN; ?></td>
                                                <td style="width:10%;"><?php echo $cp -> clientPhone1; ?></td>
                                                <td style="width:58%;"><?php if ($cp -> coti ==1){?><i class="material-icons blue-text">done</i> <?php }else  {?> <i class="material-icons blue-text">cancel</i><?php }?></td>
                                                <td style="width:6%;">
                                              ...
                                              <a href="
                                                        <?php
                                                        echo $link = $_SESSION["userAdmin"] == 2 ? "../c/{$module}.php?m=delete&cid={$cp2-> c1Id}&d={$cp -> diagnosticoId}" : "../c/{$module}.php?m=delete&cid={$cp-> c1Id}&d={$cp -> diagnosticoId}"; ?>" 
                                                        class="tooltipped m-l-10" data-position="top" data-tooltip="Eliminar">
                                                        <i class="material-icons <?php echo $color = $_SESSION["userAdmin"] == 2 ? "red-text" : "red-text"; ?>">delete</i></a>
                                   ...
                                   <table id='example2' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $cp -> clientEmail; ?></td>
                                                <td><?php echo $cp -> clientPhone1; ?></td>
                                                <td><?php if ($cp -> coti ==1){?><i class="material-icons blue-text">done</i> <?php }else  {?> <i class="material-icons blue-text">cancel</i><?php }?></td>
                                                <td>
