...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Preguntas Modelos AC</a>
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="blue-text p-l-10">Preguntas Modelos AC</span>
                                   ...
                                   <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            ...
                                            <!--<td><?php echo $diagnosticoName ?></td>-->
                                               ...
                                               <td><?php echo $cp -> pacName; ?></td> 
                                               
                                               <?php if ($_SESSION["userAdmin"] == 4) { ?>
                                                        <td class="center">
                                                            <a target="_blank" href='../plugins/pdf/doc/pac.php?id=<?php echo $cp -> pacId; ?>' class='tooltipped' data-position='left' data-tooltip='Ver'><i class='material-icons blue-text'>search</i></a>
                                                        </td>
                                                        <?php } else { ?>
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update&pid={ $cp -> pacId}&cid={$d}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=update&pid={$cp -> pacId}&cid={$d}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update2&pid={$cp -> pacId}&cid={$d}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update2&pid={$cp -> pacId}&cid={$d}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=delete&pid={$cp -> pacId}&cid={$d}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jDelete == 1 ? "../c/{$module}.php?m=delete&pid={$cp -> pacId}&cid={$d}" : "javascript: void(0)";
                                                                }
