...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Plan Suscriptores</a>
                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                    <form id="form_validation" action="../c/plan.php?m=createDb" method="post">
                                        <div class="row">
                                            <div class="col s12 m6 l2">
                                                <div class="input-field">
                                                    <input id="planName" name="planName" placeholder="" type="text" class="validate">
                                            ...
                                            <div class="col s12 m6 l2">
                                                <div class="input-field">
                                                    <input id="text1" name="text1" placeholder="" type="text" class="validate">
                                            ...
                                            <div class="col s12 m6 l2">
                                                <div class="input-field">
                                                    <input id="text2" name="text2" placeholder="" type="text" class="validate">
                                            ...
                                            <div class="col s12 m6 l2">
                                                <div class="input-field">
                                                    <input id="text3" name="text3" placeholder="" type="text" class="validate">
                                            ...
                                            <div class="col s12 m6 l2">
                                                <div class="input-field">
                                                    <input id="text4" name="text4" placeholder="" type="text" class="validate">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-30">
                                                ...
                                                <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vDepartment' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                            </div>
                                        </div>
                                    </form>
                                </div>
