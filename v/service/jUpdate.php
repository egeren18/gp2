        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Servicios</a>
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/service.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 m6">
                                                        <div class="input-field">
                                                            <select id="natureId" name="natureId" placeholder="" type="text" class="validate">
                                                                <option value="">&nbsp;</option>
                                                                <?php while ($nature = $_nature -> fetch_object()) { ?>
                                                                <option <?php echo $selected = $service -> natureId == $nature -> natureId ? "selected" : ""; ?> value="<?php echo $nature -> natureId; ?>"><?php echo $nature -> natureName; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                            <label class="font-13" for="natureId">Naturaleza del Servicio</label>
                                                            <span class="helper-text" data-error="El campo es requerido" data-success=""></span>
                                                        </div>
                                                    </div>
                                                    <div class="col s12 m6">
                                                        <div class="input-field">
                                                            <input value="<?php echo $service -> serviceName; ?>" id="serviceName" name="serviceName" placeholder="" type="text" class="validate">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <?php echo $action = $_SESSION["userAdmin"] != 4 ? "<button id='vService' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar Cambios'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
