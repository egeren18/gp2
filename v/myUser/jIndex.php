                ...
                <div class="col s12 m12 l12 m-t-5">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <a href="#!" class="breadcrumb  m-l-10">Usuarios</a>
                                        ...
                                        <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                            <table id="example" class="display nowrap" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo $user -> userName . " " . $user -> userSurname; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $type = $user -> userAdmin == 3 ? "Socio de Riesgo" : ($user -> userAdmin == 1 ? "Est&aacute;ndar" : "Admin"); ?>
                                                        </td>
                                                        <td>
                                                            <a href="<?php echo $link = $_SESSION["userAdmin"] == 2 ? "../c/myUser.php?m=update&id={$user -> userId}&mod={$_GET['mod']}" : "javascript: void(0)"; ?>" class="tooltipped right m-r-10" data-position="left" data-tooltip="Modificar"><i class="material-icons <?php echo $icon = $_SESSION["userAdmin"] == 2 ? "blue-text" : "grey-text"; ?>">edit</i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
