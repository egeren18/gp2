    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/tsac.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                                                    ...
                                                    <div class="row">
                                                       <div class="col s12 m6 l6">
                                                            <div class="input-field">
                                                              <input id="tsacName" name="tsacName" placeholder="" type="text" class="validate" required>
                                                                <label for="clientName">Tipo de Cuestionario</label>
