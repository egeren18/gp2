                    ...
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Ingresar Actividad</span>
...
<form id="form_validation" action="../c/mproject.php?m=createDb4&serviceId=<?php echo $_GET['serviceId'] ?>&mcategoriaId=<?php echo $_GET['mcategoriaId'] ?>&etapaId=<?php echo $_GET['etapaId'] ?>" method="post"
