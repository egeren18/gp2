...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Cuestionarios de <?php echo $tsacName ?></a>
        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="blue-text p-l-10">Cuestionarios de <?php echo $tsacName ?></span>
                              <a href="../c/main.php?m=menu" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                ...
                                <a href="../c/<?php echo $module?>.php?m=create&tsacId=<?php echo $tsacId;?>" class="tooltipped right modal-trigger" data-position="left" data-tooltip="Agregar Pregunta de Cuestionario">
                                   ...
                                   <table id='example' class='display nowrap' style='width:100%'>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> General </td>
                                                <td><a href="../c/<?php echo $module;?>.php?m=general&tsacId=<?php echo $tsacId;?>">Preguntas</a></td>
                                            <td>
                                                
                                                     <a href="../c/<?php echo $module;?>.php?m=general&tsacId=<?php echo $tsacId;?>"
                                                            class="tooltipped  " data-position="left" data-tooltip="Consultar">
                                                                <i class="material-icons blue-text rotate-90">search</i></a>
                                            ...
                                            <tr>
                                             ...
                                             <td><a target="_blank" href="../c/pac.php?m=pac&tsacId=<?php echo $tsacId?>&cuestionarioId=<?php echo $cp -> cuestionarioId?>">Preguntas</a></td>
                                                        <td>
                                                            <a href="
                                                                <?php
                                                                $f = $service -> modeloId;
                                                                if ($_SESSION["userAdmin"] == 4) {
                                                                    ...
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=pac&tsacId={$tsacId}&cuestionarioId={$cp -> cuestionarioId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=pac&tsacId={$tsacId}&cuestionarioId={$cp -> cuestionarioId}" : "javascript: void(0)";
                                                                }
