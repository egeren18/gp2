        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m6 l3">
                    <a href="../c/project.php?m=planning&c=<?php echo $c; ?>&serviceId=<?php echo $serviceId;?>&md=<?php echo $md;?>" class="waves-effect waves-light btn btn-block blue-grey lighten-1 hoverable">
                ...
                <div class="col s12 m6 l3">
                    <a href="../c/project.php?m=strategy&c=<?php echo $c; ?>&serviceId=<?php echo $serviceId;?>&md=<?php echo $md;?>" class="waves-effect waves-light btn btn-block blue-grey lighten-1 hoverable">
                        <i class="material-icons blue-grey-text left">extension</i>
                ...
                <div class="col s12 m6 l3">
                    <a href="../c/project.php?m=conclusion&c=<?php echo $c; ?>&serviceId=<?php echo $serviceId;?>&md=<?php echo $md;?>" class="waves-effect waves-light btn btn-block blue-grey darken-2 hoverable">
                        <i class="material-icons blue-text text-darken-2 left">extension</i>
                            ...
                            <div class="m-l-10">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <?php
                                        $rcontador = 1;
                                        $status = mysqli_query($pquest, "SELECT * FROM permisos$vv WHERE userId = '" . $_SESSION["userId"] . "' and role != 0  and etapaId = 4");
