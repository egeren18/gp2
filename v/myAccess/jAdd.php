    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/access.php?m=createDb&id=<?php echo $_GET["id"]; ?>" method="post">
                <div class="row">
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <a href="#!" class="breadcrumb  m-l-10">Usuario</a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s6 m4 l3 m-t-30">
                                                <div class="card hoverable">
                                                    <div class="card card-title blue-grey lighten-1">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <p>
                                                            <label style="padding-left: 20px">
                                                                <input value="1" type="checkbox" name="jList[<?php echo $module -> moduleId; ?>]" /><span class="blue-grey-text text-darken-2"> Ver</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label style="padding-left: 20px">
                                                                <input value="1" type="checkbox" name="jAdd[<?php echo $module -> moduleId; ?>]" /><span class="blue-grey-text text-darken-2"> A&ntilde;adir</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label style="padding-left: 20px">
                                                                <input value="1" type="checkbox" name="jUpdate[<?php echo $module -> moduleId; ?>]" /><span class="blue-grey-text text-darken-2"> Modificar</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label style="padding-left: 20px">
                                                                <input value="1" type="checkbox" name="jDelete[<?php echo $module -> moduleId; ?>]" /><span class="blue-grey-text text-darken-2"> Eliminar</span>
                                                            </label>
                                                        </p>
                                                        <div class="m-t-5"></div>
                                                    </div>
