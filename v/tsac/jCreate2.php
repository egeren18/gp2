    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/tsac.php?m=createDb2&tsacId=<?php echo $id;?>" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <a href="../c/tsac.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                                    ...
                                                    <div class="row">
                                                       <div class="col s12 m6 l6">
                                                            <div class="input-field">
                                                              <input id="tsacName" name="tsacName" placeholder="" type="text" value="<?php echo $tsacName;?>" readonly>
                                                                <label for="tsacName">Tipo de Cuestionario</label>
                                                 
                                                            </div>
                                                        </div>
                                                        <div class="col s12 m6 l6">
                                                            <div class="input-field">
                                                              <input id="cuestionarioName" name="cuestionarioName" placeholder="" type="text" class="validate" required>
                                                                <label for="cuestionarioName">Modelo de Cuestionario</label>
