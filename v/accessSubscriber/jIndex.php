                                            ...
                                            <table id="example" class="display nowrap" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../c/accessSubscriber.php?m=user&sid=<?php echo $subscriber -> subscriberId; ?>" class="tooltipped right m-r-10" data-position="left" data-tooltip="Modificar"><i class="material-icons blue-text rotate-90">search</i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
