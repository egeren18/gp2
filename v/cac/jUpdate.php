...
<div class="container">
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Editar</a>
...
<form id="form_validation" action="../c/cac.php?m=updateDb&tsacId=<?php echo $tsacId;?>&cuestionarioId=<?php echo $cuestionarioId;?>&cacId=<?php echo $cacId?>&g=<?php echo $g;?>" method="post"
enctype="multipart/form-data" onsubmit="return checkForm(this);">
 ...
 <div class="row">   
    ...
    <div class="col s12 m12 l6  m-t-10 ">
        <div class="input-field">
            <input value="<?php echo $cn;?>" id="cacName" name="cacName" placeholder="" type="text" class="validate" required>
