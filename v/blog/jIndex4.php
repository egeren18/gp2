                ...
                <div class="col s12 m12 l12 m-t-5">
                    <div class="card blue-grey lighten-5 hoverable">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <span class="blue-text p-l-10">Blog  <?php echo $n ?></span>
                                            ...
                                            <table id='example' class='display nowrap' style='width:100%'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                    <?php if($blog -> blogStatus ==1){?><i class="material-icons m-l-10 green-text">done_all</i><?php }?>
                                                    <?php if($blog -> blogStatus ==2){?><i class="material-icons m-l-10">done</i><?php }?>
                                                   
                                                        </td>
                                                        <td>
<a href="#" class="tooltipped " data-position="left" data-tooltip="Consultar"><i class="material-icons grey-text" >search</i></a>
<a href="#" class="tooltipped m-l-10 " data-position="left" data-tooltip="Modifiar"><i class="material-icons  grey-text">edit</i></a>
