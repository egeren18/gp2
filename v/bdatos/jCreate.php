    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/bdatos.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                    <div class="col s12 m12 l12 m-t-5">
                        <div class="card blue-grey lighten-5 hoverable">
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        <span class="blue-text p-l-10">Base a tranferir</span>
                                        <a href="../c/bdatos.php?m=index" class="tooltipped right " data-position="left" data-tooltip="Cerrar">
                                ...
                                <a class="right m-r-5 tooltipped" id="a-make" href="#" data-position="left" data-tooltip="Capturar Pantalla"><i class="material-icons">photo_camera</i></a>
                                 ...
                                 <a class="right m-r-5" id="a-return" href="#" style="display:none;"><span class="m-r-5">Cerrar Im&aacute;gen</span></a>
                                    ...
                                    <div class="card p-t-20 p-b-15 p-l-20 p-r-20">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l6">
                                                            <div class="input-field">
                                                                <input id="ckeditor" name="bdatosName" placeholder="" type="text" class="validate" required>
                                                                <label for="bdatosName">Base a tranferir</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m12 l12 ">
                                                            <div class="input-field">
                                                                 <textarea id="ckeditor" name="bdatosText" class="ckeditor m-t-20" required>
                                                                 </textarea>
                                                                 <label  for="textarea1">Texto De Base a tranferir</label>
                                                            </div>
                                                        </div>
                                                        
                                                    </div>
                                                    
                                                <!-- inicio de archivo adjunto-->    
                                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-20">
                                                <a href="../c/bdatos.php?m=index" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
