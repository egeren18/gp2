 ...
 <form id="form_validation" action="../c/blog.php?m=deleteDb&id=<?php echo $_GET["id"]; ?>" method="post">
   <div class="row">
      <div class="col s12 m6 l4">
          <div class="input-field">
           <input value="<?php echo $blog -> blogText; ?>"type="text" disabled="">

               <label for="blogText">Titulo</label>
