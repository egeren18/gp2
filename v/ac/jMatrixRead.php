                ...
                <div class="p-l-10 p-r-10 p-b-10">
                    <div class="row grey lighten-3 ">
                        <div class="col s12 m-b-10">
                            ...
                            <label>
                                <input type="radio" name="r<?php echo $acu;?>" value="0" <?php echo $checked = $prisk -> r == 0 ? "checked" : ""; ?> disabled=""/>
                                <span>No Aplica</span>
                            </label>
                            <label class="p-l-20">
                                <input type="radio" name="r<?php echo $acu;?>" value="1" <?php echo $checked = $prisk -> r == 1 ? "checked" : ""; ?> disabled=""/>
                                <span>Bajo</span>
                            </label>
                            <label class="p-l-20">
                                <input type="radio" name="r<?php echo $acu;?>" value="2" <?php echo $checked = $prisk -> r == 2 ? "checked" : ""; ?> disabled=""/>
                                <span>Bajo - Moderado</span>
                            </label>
                            <label class="p-l-20">
                                <input type="radio" name="r<?php echo $acu;?>" value="3" <?php echo $checked = $prisk -> r == 3 ? "checked" : ""; ?> disabled=""/>
                                <span>Moderado</span>
                            </label>
                            <label class="p-l-20">
                                <input type="radio" name="r<?php echo $acu;?>" value="4" <?php echo $checked = $prisk -> r == 4 ? "checked" : ""; ?> disabled=""/>
                                <span>Moderado - Alto</span>
                            </label>
                            <label class="p-l-20">
                                <input type="radio" name="r<?php echo $acu;?>" value="5" <?php echo $checked = $prisk -> r == 5 ? "checked" : ""; ?> disabled=""/>
                                <span>Alto</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="p-l-10 p-r-10 p-b-10">
                        <div class="col s12 m6 l6">
                            ...
                            <textarea name="d<?php echo $acu;?>" class="ckeditor" readonly><?php echo $prisk -> d; ?></textarea>
                        </div>
                        <div class="col s12 m6 l6">
                            <div class="blue-text m-b-10">Respuesta al Riesgo Identificado</div>
                            <textarea name="a<?php echo $acu;?>" class="ckeditor" readonly><?php echo $prisk -> a; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
