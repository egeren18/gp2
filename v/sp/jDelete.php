                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                    <form id="form_validation" action="../c/sp.php?m=deleteDb&cid=<?php echo $_GET["cid"]; ?>" method="post">
                                        <div class="row">
                                            <div class="col s12 m6 l4">
                                                <div class="input-field">
                                                    <input value="<?php echo $client -> gestiontalentoName; ?>"type="text" disabled="">
                                                    <label for="gestiontalentoName">Datos</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
