        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#help" class="tooltipped right m-r-10 modal-trigger" data-position="left" data-tooltip="termycond de Usuario">
            ...
            <form id="form_validation" action="../c/termycond.php?m=createt" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                                                    ...
                                                    <div class="col s12 m6 l6 m-t-10 ">
                                                             <div class="input-field">
                                                                <select id="clientId" name="clientId" placeholder="" type="text" class="validate">
                                                                    <option value="">&nbsp;</option>
                                                                    <?php while ($g = $_client -> fetch_object()) { ?>
                                                                    <option value="<?php echo $g -> clientId; ?>"><?php echo $g -> clientName; ?></option>
                                                                    <?php } ?>
                                                                </select>
