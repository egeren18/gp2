        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="breadcrumb  p-l-10">Cuestionario</span>
                                ...
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id="example" class="display nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            <td>
                                                    <?php echo $cuestionario -> moduleController; ?>
                                                </td>
                                                <td>
                                                    <?php echo $cuestionario -> cuestionarioName; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="
                                                        ...
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            $allow = 1;
                                                            echo $link = $allow == 1 ? "../c/{$module}.php?m=list&id={$cuestionario -> cuestionarioId}" : "javascript: void(0)";
                                                        }
                                                        else {
                                                            echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=list&id={$cuestionario -> cuestionarioId}" : "javascript: void(0)";
                                                        }
                                                    ...
                                                    <a href="
                                                        ...
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            ...
                                                            echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update&id={$cuestionario -> cuestionarioId}" : "javascript: void(0)";
                                                        }
