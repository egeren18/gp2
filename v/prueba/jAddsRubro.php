                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="prueba.php?m=addDb&rid=<?php echo $rubroId;?>&cn=<?php echo $clientName;?>" method="post">
                                            <div class="row">
                                                    ...
                                                    <div class="col s12 m12 l12 m-t--30">
								                        ...
								                        <select data-size="4" name="sRubroId" class="form-control show-tick" data-live-search="true" required>
								                            ...
								                            <?php while ($r_r = mysqli_fetch_array($sRubro)) { ?>
								                                <option value="<?php echo $r_r["sRubroId"]; ?>"><?php echo $r_r["sRubroName"]; ?></option>
								                            <?php } ?>
								                        </select>
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col s12 m12 l12 m-t--30 ">
                                                        <div class="input-field">
                                                            <input id="srubroName" name="pruebaName" placeholder="" type="text" class="validate" required>
