                            ...
                            <div class="row">
                                <div class="col s6 m3">
                                     ...
                                     <div class="col s6 m3">
                                        ...
                                        <form id="form_validation" action="../c/mproject.php?m=updateDb2&serviceId=<?php echo $_GET['serviceId'] ?>&mcategoriaId=<?php echo $_GET['mcategoriaId'] ?>&etapaId=<?php echo $_GET['etapaId'] ?>&actividadId=<?php echo $_GET['actividadId'] ?>" method="post">
                                                ...
                                                <div class="col s12 m-t-10">
                                                        ...
                                                        <div class="col s12 m-t--10">
                                                        <div class='card-panel black-text blue-grey lighten-4' style='line-height : 20px;'><?php echo $actividadName ?></div>
                                                       </div>
                                                  </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="actividadText" name="actividadText" class="ckeditor m-t-20">
                                                    <?php echo $actividadText ?>
                                                     </textarea>
                                                     <label  for="textarea1">Texto Resumido</label>
                                                 </div>
                                           ...
                                           <div class="col s12 m12 l6 ">
                                                 <div class="input-field">
                                                      <textarea id="actividadName" name="actividadName" class="ckeditor m-t-20">
                                                    <?php echo $actividadName ?>
                                                     </textarea>
                                                     <label  for="textarea1">texto completo</label>
                                                 </div>
