...
<div class="card white m-t-10 m-l-5 m-r-5">
    <div class="row   ">
        ...
        <table id='example' class='display nowrap' style='width:100%'>
                    ...
                    <td><a href="../c/ticket.php?m=read&id=<?php echo $ticket -> ticketId; ?>" 
                   target="_blank" class="tooltipped " data-position="left" data-tooltip="Consultar">
                    <i class="material-icons blue-text">search</i></a></td>
                    
                    <td>
                    
                                    <a href="" class="tooltipped m-l-10" data-position="top" data-tooltip="Estado">
                                    <?php if($ticket -> ticketStatus >= 3){?><i class="material-icons green-text">done_all</i><?php } ?>
                                    <?php if($ticket -> ticketStatus < 3){?><i class="material-icons ">done</i><?php } ?>
