        ...
        <div class="col s12 m12 l12 m-t-5">
            <div class="card blue-grey lighten-5 hoverable">
                <div class="card-content">
                    <div class="row">
                        <div class="col s12">
                            <span class="breadcrumb p-l-10">Leer</span>
                            <a href="#!" class="breadcrumb">Otras consideraciones</a>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col s12 m8 ">
                                            <div class="input-field">
                                                <input id="titulo" name="titulo" value="<?php echo $titulo ?>"  type="text" readonly>
                                            ...
                                            <div class="collapsible-header grey lighten-4"><i class="material-icons blue-text">list</i>Descripci&oacute;n</div>
                                                <div class="collapsible-body">
                                                  		<div class= "row">
                                                            <div class="col s12 m12 l12 ">
                                                                <div class="input-field">
                                                                <textarea id="ckeditor" name="oconsideracionesText"  class="ckeditor m-t-20" readonly>
                                                                <?php echo $texto1 ; ?>    
                                            ...
                                            <div class="collapsible-header grey lighten-4"><i class="material-icons blue-text">list</i>Recomendaciones del asunto</div>
                                                <div class="collapsible-body">
                                                  		<div class= "row">
                                                            <div class="col s12 m12 l12 ">
                                                                <div class="input-field">
                                                                <textarea id="ckeditor" name="oconsideracionesText2" class="ckeditor m-t-20" readonly>
                                                                <?php echo $texto2 ; ?>
                                                                </textarea>
