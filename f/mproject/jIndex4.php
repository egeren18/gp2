...
$_actividad = mysqli_query($master, "
    ...
    WHERE actividadStatus = 1 AND serviceId = '" . $serviceId . "' AND etapaId = '" . $etapaId . "' AND mcategoriaId = '" . $mcategoriaId . "'  
");
...
$actividadName = $actividadName -> actividadName ;
...
switch ($n) {
    ...
    case 'added':
        echo $added;
        require_once '../v/mproject/jIndex4.php';
        break;
