                        ...
                        <div id="screenshot">
                            <div class="card m-t-10 m-l-5 m-r-5">
                                <div class="p-l-20 p-t-20 p-r-20 p-b-20">
                                    ...
                                    <form id="form_validation" action="../c/termycond.php?m=teamc&termycondId=<?php echo $termycondId; ?>&clientId=<?php echo $clientId;?>&serviceId=<?php echo $serviceId;?>" method="post">
                                        <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="border-grey" class="center">
                                                            <?php echo $permission = $_SESSION["userAdmin"] == 2 ? "<a href='../c/termycond.php?m=teamDelete&termycondId={$termycondId}&clientId={$clientId}&serviceId={$serviceId}&teamId={$team -> teamId}' class='tooltipped m-r-5' data-position='left' data-tooltip='Eliminar'><i class='material-icons red-text'>delete</i></a>" : "<i class='material-icons grey-text'>delete</i>"; ?>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
