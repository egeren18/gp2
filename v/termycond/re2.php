                        ...
                        <div class="col s12 m3 m-t-20">
                            <div class="input-field col s12">
                                <select name="frecuencia">
                                        <option value="<?php echo $frecuencia?>" disabled selected readonly><?php echo $frecuencia?></option>
                                </select>
...
<form action="../c/termycond.php?m=createDb11&termycondId=<?php echo $termycondId?>&iid=<?php echo $iid ;?>" method="post">                 
                    <div class="row">
                        ...
                        <?php if ($frecuencia >= 1){?>
                         <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha1" class="datepicker" value="<?php echo $f1;?>" readonly>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha2" class="datepicker" value="<?php echo $f2;?>" readonly>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha3" class="datepicker" value="<?php echo $f3;?>" readonly>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha4" class="datepicker" value="<?php echo $f4;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha5" class="datepicker" value="<?php echo $f5;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha6" class="datepicker" value="<?php echo $f6;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha7" class="datepicker" value="<?php echo $f7;?>" readonly>
                            </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha8" class="datepicker" value="<?php echo $f8;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha9" class="datepicker" value="<?php echo $f9;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha10" class="datepicker"  value="<?php echo $f10;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha11" class="datepicker" value="<?php echo $f11;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
                        ...
                        <div class="col s12 m2">
                            <div class="input-field">
                                ...
                                <input style="text-align: center;" type="text" name="fecha12" class="datepicker" value="<?php echo $f12;?>" readonly>
                            </div>
                        </div>
                        <?php }?>
   ...
   <!-- terminar -->
          <form action="../c/termycond.php?m=updateDb2&termycondId=<?php echo $termycondId?>&serviceId=<?php echo $serviceId?>&clientId=<?php echo $clientId?> "method="post">  
 <div class="row">
