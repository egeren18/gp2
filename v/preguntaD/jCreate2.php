...
<div class="container">
    ...
    <form id="form_validation" action="../c/preguntaD.php?m=createDb&d=<?php echo $d; ?>&pn=<?php echo $pn; ?>" method="post">
        <div class="row">
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col s12">
                                ...
                                <a href="../c/preguntaD.php?m=list&pid=<?php echo $d; ?>" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                         ...
                         <div class="row">
                            ...
                            <div class="row">
                                        <div class="col s12 m12 l12  ">
                                                 <div class="input-field">
                                                    <input id="preguntaName" name="preguntaName" value="<?php echo $pn; ?>" type="text"  readonly>
                                                        ...
                                                        <div class="row">
                                                            <?php while ($cp = $_cp -> fetch_object()) {?>
                                                                <div class="col l4">
                                                                    ...
                                                                    <input class="filled-in" type="checkbox" name="pc[<?php echo $cp -> categoriasId; ?>]"/>
                                                                    <span class="blue-grey-text text-darken-2"><?php echo $cp -> categoriasName; ?></span>
                                                                </label>
                                                                                </div> </td>
                                ...
                                <div class="row">
                                    <div class="col s12 m-t-20">
                                        <a href="../c/preguntaD.php?m=list&pid=<?php echo $d; ?>" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
